...
FILE_LIST += $(wildcard $(LOCAL_PATH)/sbox/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/blackrussia/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/weikton/*.cpp)
...
FILE_LIST += $(wildcard $(LOCAL_PATH)/gtasa/encryption/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/gtasa/encryption/*.c)
