...
#include "../gtasa/encryption/CTinyEncrypt.h"
#include "../gtasa/encryption/encrypt.h"

#include "../CAudioStream.h"

#include "../sbox/CRQ_Commands.h"
#include "../sbox/CSkyBox.h"
...
extern "C"
{
       #include "../gtasa/encryption/aes.h"
}
...
void MobileMenu__Render_hook(uintptr_t thiz)
{
	...
	if(pGUI)CFont::PrintString(pGUI->ScaleX(5), pGUI->ScaleY(5), cryptor::create("WEIKTON", 11).decrypt());
}
...
void InstallSpecialHooks()
{
	...
	WriteMemory(g_libGTASA + 0x0023BEDE, (uintptr_t)"\x00\x46\x00\x46", 4);
                  ...
                  //SetUpHook(g_libGTASA + 0x23768C, (uintptr_t)ANDRunThread_hook, (uintptr_t*)&ANDRunThread);
...
#include "../blackrussia/CRenderTarget.h"
#include "..//gui/CFontInstance.h"
#include "..//gui/CFontRenderer.h"
#include "../blackrussia/CCustomPlateManager.h"
...
void InstallHooks()
{
	PROTECT_CODE_INSTALLHOOKS;
                  ...
                  SetUpHook(g_libGTASA + 0x25AFF4, (uintptr_t)MobileMenu__Render_hook, (uintptr_t*)&MobileMenu__Render);
