...
void CVehicle::toggleReverseLight(bool toggle)
{
    ...
    m_avDummyPos = *(float**)(dwModelarray[m_pVehicle->entity.nModelIndex] + 116);

    VECTOR vecRight;
    vecRight.X = m_avDummyPos[3];
    vecRight.Y = m_avDummyPos[4];
    vecRight.Z = m_avDummyPos[5];

    VECTOR vecLeft;
    vecLeft.X = -m_avDummyPos[3];
    vecLeft.Y = m_avDummyPos[4];
    vecLeft.Z = m_avDummyPos[5];
...
void CVehicle::toggleRightTurnLight(bool toggle)
{
    ...
    VECTOR vecFront;
    // 0 - front light
    vecFront.X = m_avDummyPos[0] + 0.1;
    vecFront.Y = m_avDummyPos[1];
    vecFront.Z = m_avDummyPos[2];

    VECTOR vecRear;
    vecRear.X = m_avDummyPos[3] + 0.1;
    vecRear.Y = m_avDummyPos[4];
    vecRear.Z = m_avDummyPos[5];
...
void CVehicle::toggleLeftTurnLight(bool toggle)
{
    ...
    VECTOR vecFront;
    // 0 - front light
    vecFront.X = -(m_avDummyPos[0] + 0.1f);
    vecFront.Y = m_avDummyPos[1];
    vecFront.Z = m_avDummyPos[2];

    VECTOR vecRear;
    vecRear.X = -(m_avDummyPos[3] + 0.1f);
    vecRear.Y = m_avDummyPos[4];
    vecRear.Z = m_avDummyPos[5];
