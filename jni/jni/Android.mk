...
LOCAL_LDLIBS := -llog -lEGL -lGLESv2 -lOpenSLES
...
FILE_LIST += $(wildcard $(LOCAL_PATH)/util/interfaces/*.cpp)
...
FILE_LIST += $(wildcard $(LOCAL_PATH)/../tea-gtasa/encryption/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../tea-gtasa/encryption/*.c)
