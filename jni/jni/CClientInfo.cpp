...
extern "C"
{
	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientIp(JNIEnv* pEnv, jobject thiz, jbyteArray ip)
	{
		CClientInfo::SetClientIP(pEnv, thiz, ip);
	}

	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientPort(JNIEnv* pEnv, jobject thiz, jint port)
	{
		CClientInfo::SetClientPort(pEnv, thiz, port);
	}

	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientUuid(JNIEnv* pEnv, jobject thiz, jbyteArray uuid)
	{
		CClientInfo::SetClientUUID(pEnv, thiz, uuid);
	}

	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientLauncherVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientLauncherVersion(pEnv, thiz, version);
	}
	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientModpackVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientModPackVersion(pEnv, thiz, version);
	}
	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientMajorVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientMajorVersion(pEnv, thiz, version);
	}
	JNIEXPORT void JNICALL Java_com_flinc_core_GTASA_setClientMinorVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientMinorVersion(pEnv, thiz, version);
	}
	JNIEXPORT jboolean JNICALL Java_com_flinc_core_GTASA_isAPAKAndLibSame(JNIEnv* pEnv, jobject thiz, jint gameEdition)
	{
...
void CClientInfo::SetClientIP(JNIEnv* pEnv, jobject thiz, jbyteArray ip)
{
	...
	Log(OBFUSCATE("Setted ip: %s"), szIP);

	firebase::crashlytics::SetCustomKey(OBFUSCATE("IP"), szIP);
...
void CClientInfo::SetClientPort(JNIEnv* pEnv, jobject thiz, jint port)
{
	...
	Log(OBFUSCATE("Setted port: %d"), usPort);
}
...
void CClientInfo::SetClientUUID(JNIEnv* pEnv, jobject thiz, jbyteArray uuid)
{
	...
	firebase::crashlytics::SetCustomKey(OBFUSCATE("UUID"), szSerial);
	//Log(OBFUSCATE("Mihail UUID: %s"), szSerial);
...
void CClientInfo::SetClientLauncherVersion(JNIEnv* pEnv, jobject thiz, jint version)
{
	...
	Log(OBFUSCATE("Setted launcher version: %d"), usLauncherVersion);
}
...
void CClientInfo::SetClientModPackVersion(JNIEnv* pEnv, jobject thiz, jint modpack)
{
	...
	Log(OBFUSCATE("Setted modpack version: %d"), usModpackVersion);
}
