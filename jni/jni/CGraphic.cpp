...
void CGraphic::ApplyRange(int range) {
    SetMemoryValue(g_libGTASA + 0x63E3C4, range);
}
...
void CGraphic::ApplyShadows(int shadows) {
    SetMemoryValue(g_libGTASA + 0x63E324, shadows);
}
