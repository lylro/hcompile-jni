...
void CJavaWrapper::TempHud(bool state)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_tempHud, state);
}

void CJavaWrapper::UpdateHudInfo(int health, int armour, int hunger, int weaponid, int ammo, int ammoinclip, int playerid, int money, int wanted)
{
	JNIEnv* env = GetEnv();
	...
	env->CallVoidMethod(this->activity, this->s_updateHudInfo, health, armour, hunger, weaponid, ammo, ammoinclip, playerid, money, wanted);
}
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
	...
	s_MakeDialog = env->GetMethodID(nvEventClass, "showDiolog", "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");

	s_updateHudInfo = env->GetMethodID(nvEventClass, "updateHudInfo", "(IIIIIIIII)V");
    s_showHud = env->GetMethodID(nvEventClass, "showHud", "()V");
    s_hideHud = env->GetMethodID(nvEventClass, "hideHud", "()V");
    s_tempHud = env->GetMethodID(nvEventClass, "tempStateForHud", "(Z)V");
    ...
    s_showNotification = env->GetMethodID(nvEventClass, weikton("showNotification"), weikton("(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;)V"));

    /// NEW
    s_ShowSpawnSelector = env->GetMethodID(nvEventClass, weikton("showSpawnSelector"), weikton("(ZZ)V"));
    s_ShowAZS = env->GetMethodID(nvEventClass, weikton("showAZS"), weikton("(IIFII)V"));
    s_ShowCaptcha = env->GetMethodID(nvEventClass, weikton("showCaptcha"), weikton("()V"));
    s_ShowNumbers = env->GetMethodID(nvEventClass, weikton("showNumbers"), weikton("(I)V"));
    s_GenerateNumber = env->GetMethodID(nvEventClass, weikton("generateNumber"), weikton("(Z)V"));
    s_BuyNumber = env->GetMethodID(nvEventClass, weikton("buyNumber"), weikton("(Z)V"));
    ///
