...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
		...
		"Сервер полон",
		"Вы указали некорректный ник или он уже используется",
		"Ник может состоять минимум из 3ёх символов, максимум из 20",
		"Ник может состоять только из английских букв",
		"Проверье корректность указанно ника в настройках",
		"Переустановите файлы игры",
		"Файл weapon.dat не является оригинальным",
		"Не хватает текстур воды. Перустановите файлы игры",
		"Система выявила у Вас сторонние программы при запуске игры. Не запускайте игру через сторонние программы"
};
