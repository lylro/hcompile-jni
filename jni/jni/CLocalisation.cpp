...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
	"{Ff0000}Dar Hal Connect Be Server...",
	"",
	"{ffffff}Lotfan Dobare Connect Shavid",
	"",
	"unused",
	"{ff0000}Ip Shoma Tavasot Server Close Shod!{ffcc00} Mojadad Vared Shavid",
	"Etesal Shoma Az Server Ghat Shod! Mojadad Connect Shavid...",
	"Etesal Mojadad...",
	""
};
