...
void CSettings::Save(int iIgnoreCategory)
{
    ...
    ini_table_create_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("KillListPosX"), m_Settings.fKillListPosX);
    ini_table_create_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("KillListPosY"), m_Settings.fKillListPosY);
    ini_table_create_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("KillListScale"), m_Settings.fKillListScale);
	...
	ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("voicelist"), m_Settings.iVoiceList);

	ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("fps"), m_Settings.iFPS);

	if (iIgnoreCategory != 1)
	{
		ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("xxcutout"), m_Settings.iCutout);
		...
		ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("voice"), m_Settings.iVoice);
		ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("skybox"), m_Settings.iSkyBox);
        ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("dialogNew"), m_Settings.iDialogNew);
		ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("crossHair"), m_Settings.iCrossHair);
        ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("cacheTextDraw"), m_Settings.iCacheTextDraw);
...
void CSettings::LoadSettings(const char* szNickName, int iChatLines)
{
    ...
    m_Settings.fKillListPosX = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("KillListPosX"), 800.0f);
    m_Settings.fKillListPosY = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("KillListPosY"), 220.0f);
    m_Settings.fKillListScale = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("KillListScale"), 100.0f);
	...
	m_Settings.fButtonMicrophoneSize = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("1MicrophoneSize"), 60.0f);
	...
	m_Settings.iVoiceList = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("voicelist"), 1);

	m_Settings.iFPS = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("fpsx"), 90);
	//m_Settings.iFPS = 60;

	m_Settings.iCutout = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("xxcutout"), 1);
	...
	m_Settings.iOutfitGuns = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("65usermoZert"), 0);
	m_Settings.iRadarRect = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("65radarrect"), 0);
	...
	m_Settings.iVoice = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("voice"), 1);
	m_Settings.iSkyBox = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("skybox"), 1);
    m_Settings.iDialogNew = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("dialogNew"), 1);
	m_Settings.iCrossHair = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("1crossHair"), 1);
    m_Settings.iCacheTextDraw = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("cacheTextDraw"), 0);
	m_Settings.iHud = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("snow"), 1);
	...
	Log(OBFUSCATE("Mihail Settings LOAD"));
	ini_table_destroy(config);
}
