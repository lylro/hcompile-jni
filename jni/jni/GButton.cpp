...
{
	if(pDialogWindow->m_bIsActive || pDialogWindow->m_bActiveDialog || pScoreBoard->m_bToggle || pKeyBoard->IsOpen() || !pGame->IsToggledHUDElement(HUD_ELEMENT_BUTTONS)) return;
