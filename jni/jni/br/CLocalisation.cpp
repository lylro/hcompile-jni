...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
	"Соединение к HISANNO RP...",
	"Соединено. Подготовка к игре...",
	"Сервер закрыл соеденение, перезайдите...",
	"",
	"unused",
	"Выйдите из игры и подключитесь заново.",
	"Потеряно соеденение с сервером, переподключение через пару секунд... ( CONNECTION_LOST )",
	"Потеряно соеденение с сервером, переподключение через пару секунд... ( CONNECTION_ATTEMPT_FAILED )",
