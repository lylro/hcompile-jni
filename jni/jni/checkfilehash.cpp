...
bool FileCheckSum()
{
	...
	mdCheckSumFile->iCorrectDigestArray[0] = 0;
	mdCheckSumFile->iCorrectDigestArray[1] = 2390668693;
	mdCheckSumFile->iCorrectDigestArray[2] = 3578594549;
	mdCheckSumFile->iCorrectDigestArray[3] = 1760276857;
	if(!CheckFile(mdCheckSumFile)) return false;
	...
	sprintf(mdCheckSumFile->szFileLocation, "%sSAMP/weapon.dat", g_pszStorage);
	mdCheckSumFile->iCorrectDigestArray[0] = 0;
	...
	sprintf(mdCheckSumFile->szFileLocation, "%sSAMP/ped.ifp", g_pszStorage);
	mdCheckSumFile->iCorrectDigestArray[0] = 0;
	mdCheckSumFile->iCorrectDigestArray[1] = 663012147;
	mdCheckSumFile->iCorrectDigestArray[2] = 347788485;
	mdCheckSumFile->iCorrectDigestArray[3] = 22521510;
	if (!CheckFile(mdCheckSumFile)) return false;
...
bool FileCheckSumGTA7z()
{
	...
	sprintf(mdCheckSumFile->szFileLocation, "%stexdb/gta3/gta3.txt", g_pszStorage);
	mdCheckSumFile->iCorrectDigestArray[0] = 0;
	mdCheckSumFile->iCorrectDigestArray[1] = 4123544632;
	mdCheckSumFile->iCorrectDigestArray[2] = 1542478497;
	mdCheckSumFile->iCorrectDigestArray[3] = 1960471505;
	if (!CheckFile(mdCheckSumFile)) return false;
