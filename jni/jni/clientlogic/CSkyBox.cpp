...
void CSkyBox::Initialise()
{
	...
	m_pSkyObject = CreateObjectScaled(18659, 0.8f)/* && CreateObjectScaled(18660, 0.8f)*/;
...
void CSkyBox::ReTexture()
{
	...
	((void(*)())(SA_ADDR(0x559EF8 + 1)))();
	((void*(*)())(SA_ADDR(0x559FC8 + 1)))();
	((void(*)())(SA_ADDR(0x559FEC + 1)))();
	((uintptr_t(*)(uintptr_t, uintptr_t, CObject*))(SA_ADDR(0x1AEE2C + 1)))(*(uintptr_t*)(pAtomic + 4), (uintptr_t)RwFrameForAllObjectsCallback, m_pSkyObject);
}
