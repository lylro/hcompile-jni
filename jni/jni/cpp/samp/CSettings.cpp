...
void CSettings::save(int iIgnoreCategory)
{
    ...
    ini_table_create_entry_as_int(config, "client", "server", m_Settings.server);
...
void CSettings::LoadSettings(const char *szNickName, int iChatLines)
{
    ...
    m_Settings.server = ini_table_get_entry_as_int(config, "client", "server", 0);
...
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_ChatLineChanged(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jint newcount) {
...
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_ChatFontSizeChanged(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jint size) {
...
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getNativeDamageInformer(JNIEnv *env,
                                                                                   jobject thiz) {
    return CSettings::m_Settings.iIsEnableDamageInformer;
}

JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setNativeDamageInformer(JNIEnv *env,
                                                                                   jobject thiz,
                                                                                   jboolean state) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setNativeShow3dText(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jboolean state) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getNativeShow3dText(JNIEnv *env,
                                                                               jobject thiz) {
    return CSettings::m_Settings.iIsEnable3dTextInVehicle;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getNativeFpsLimit(JNIEnv *env,
                                                                             jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setNativeFpsCount(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jint fps) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setNativeFpsCounterSettings(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setNativeOutfitGunsSettings(
        JNIEnv *env, jobject thiz, jboolean b) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettings_onSettingsWindowDefaults(JNIEnv *env, jobject thiz,
                                                                      jint category) {
    CSettings::toDefaults(category);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettings_onSettingsWindowSave(JNIEnv *env, jobject thiz) {
    CSettings::save();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setNativeHpArmourText(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jboolean b) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getNativeFpsCounterSettings(
        JNIEnv *env, jobject thiz) {
    return CSettings::m_Settings.szDebug;
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getNativeOutfitGunsSettings(
        JNIEnv *env, jobject thiz) {
    return CSettings::m_Settings.iOutfitGuns;
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getNativeHpArmourText(JNIEnv *env,
                                                                                 jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_getAndroidKeyboard(JNIEnv *env,
                                                                              jobject thiz) {
    return CSettings::m_Settings.iAndroidKeyboard;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_crmp_cr_core_DialogClientSettingsCommonFragment_setAndroidKeyboard(JNIEnv *env,
                                                                              jobject thiz,
                                                                              jboolean b) {
