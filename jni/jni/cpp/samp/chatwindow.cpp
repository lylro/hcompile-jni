...
BOOL(*BASS_Init_func)(int device, DWORD freq, DWORD flags, void* win, const void* dsguid);
...
BOOL(*BASS_ChannelSet3DPosition_func)(DWORD handlee, const BASS_3DVECTOR* to, const BASS_3DVECTOR* orient, const BASS_3DVECTOR* vel);
...
BOOL(*BASS_Set3DPosition_func)(const BASS_3DVECTOR* to, const BASS_3DVECTOR* vel, const BASS_3DVECTOR* front, const BASS_3DVECTOR* top);
...
BOOL(*BASS_SetConfig_func)(DWORD option, DWORD value);
HPLUGIN(*BASS_PluginLoad_func)(const char *file, DWORD flags);
DWORD (*BASS_ChannelFlags_func)(DWORD handle, DWORD flags, DWORD mask);
DWORD (*BASS_ChannelIsActive_func)(DWORD handle);
BOOL (*BASS_ChannelPause_func)(DWORD handle);
QWORD (*BASS_ChannelGetLength_func)(DWORD handle, DWORD mode);
double (*BASS_ChannelBytes2Seconds_func)(DWORD handle, QWORD to);


BOOL BASS_Init(int device, DWORD freq, DWORD flags, void *win, const void *dsguid)
{
	return BASS_Init_func(device, freq, flags, win, dsguid);
}
DWORD BASS_ChannelIsActive(DWORD handle)
{
	return BASS_ChannelIsActive_func(handle);
}
QWORD BASS_ChannelGetLength(DWORD handle, DWORD mode)
{
	return BASS_ChannelGetLength_func(handle, mode);
}
double BASS_ChannelBytes2Seconds(DWORD handle, QWORD to)
{
	return BASS_ChannelBytes2Seconds_func(handle, to);
}
...
BOOL BASS_ChannelPause(DWORD handlee)
{
	return BASS_ChannelPause_func(handlee);
}
...
BOOL BASS_ChannelSet3DPosition(DWORD handlee, const BASS_3DVECTOR* to, const BASS_3DVECTOR* orient, const BASS_3DVECTOR* vel)
{
	return BASS_ChannelSet3DPosition_func(handlee, to, orient, vel);
}
...
BOOL BASS_Set3DPosition(const BASS_3DVECTOR* to, const BASS_3DVECTOR* vel, const BASS_3DVECTOR* front, const BASS_3DVECTOR* top)
{
	return BASS_Set3DPosition_func(to, vel, front, top);
}
...
{
	return BASS_SetConfig_func(option, value);
}
HPLUGIN BASS_PluginLoad(const char *file, DWORD flags)
{
	return BASS_PluginLoad_func(file, flags);
}*/
...
void InitBASSFuncs()
{
    ...
    BASS_Init_func = GetBASSFunc<BOOL(*)(int device, DWORD freq, DWORD flags, void* win, const void*)>(handle, "BASS_Init");
    ...
    BASS_ChannelPause_func = GetBASSFunc<BOOL(*)(DWORD handlee)>(handle, "BASS_ChannelPause");

    BASS_ErrorGetCode_func = GetBASSFunc<int (*)() >(handle, "BASS_ErrorGetCode");

    BASS_ChannelSet3DPosition_func = GetBASSFunc< BOOL(*)(DWORD handlee, const BASS_3DVECTOR * to, const BASS_3DVECTOR * orient, const BASS_3DVECTOR * vel)>(handle, "BASS_ChannelSet3DPosition");
    ...
    BASS_Set3DPosition_func = GetBASSFunc<BOOL(*)(const BASS_3DVECTOR * to, const BASS_3DVECTOR * vel, const BASS_3DVECTOR * front, const BASS_3DVECTOR * top)>(handle, "BASS_Set3DPosition");
    ...
    BASS_SetConfig_func = GetBASSFunc<BOOL(*)(DWORD option, DWORD value)>(handle, "BASS_SetConfig");
    BASS_PluginLoad_func = GetBASSFunc<HSTREAM (*)(const char *file, DWORD flags)>(handle, "BASS_PluginLoad");

    BASS_ChannelFlags_func = GetBASSFunc< DWORD(*)(DWORD handle, DWORD flags, DWORD mask)>(handle, "BASS_ChannelFlags");
    BASS_ChannelIsActive_func = GetBASSFunc< DWORD(*)(DWORD handle)>(handle, "BASS_ChannelIsActive");
    BASS_ChannelGetLength_func = GetBASSFunc< QWORD (*)(DWORD handle, DWORD mode)>(handle, "BASS_ChannelGetLength");
    BASS_ChannelBytes2Seconds_func = GetBASSFunc< double (*)(DWORD handle, QWORD to)>(handle, "BASS_ChannelBytes2Seconds");*/
}
