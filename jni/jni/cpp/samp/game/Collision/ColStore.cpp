...
CVector CColStore::ms_vecCollisionNeeded = CVector {};
void CColStore::InjectHooks() {
    ...
    CHook::HookRedirect("_ZN9CColStore10InitialiseEv", CColStore::Initialise);

    //CHook::Redirect(g_libGTASA, 0x002E23F4, &CColStore::Shutdown);
    CHook::HookRedirect("_ZN9CColStore8ShutdownEv", CColStore::Shutdown);

    //CHook::Redirect(g_libGTASA, 0x002E21A0, &CColStore::AddColSlot);
    CHook::HookRedirect("_ZN9CColStore10AddColSlotEPKc", CColStore::AddColSlot);
