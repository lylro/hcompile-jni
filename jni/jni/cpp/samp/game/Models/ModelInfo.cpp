...
void CModelInfo::InjectHooks()
{
    ...
    CHook::HookRedirect("_ZN10CModelInfo11AddPedModelEi", CModelInfo::AddPedModel);
    CHook::HookRedirect("_ZN10CModelInfo15AddVehicleModelEi", CModelInfo::AddVehicleModel);
    CHook::HookRedirect("_ZN10CModelInfo14AddAtomicModelEi", CModelInfo::AddAtomicModel);
