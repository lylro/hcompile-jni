...
{
	//splashTexture = CUtil::LoadTextureFromDB("samp", "hud_back");
    gpShadowHeadLightsTex2 = CUtil::LoadTextureFromDB("gta3", "headlight1");
    gpShadowExplosionTex = CUtil::LoadTextureFromDB("gta3", "shad_exp");
