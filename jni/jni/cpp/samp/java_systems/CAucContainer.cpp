...
Java_com_criminal_moscow_gui_AucContainer_Init(JNIEnv *env, jobject thiz) {
    jAucContainer = env->NewGlobalRef(thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_AucContainer_SendClick(JNIEnv *env, jobject thiz, jint button_id) {
