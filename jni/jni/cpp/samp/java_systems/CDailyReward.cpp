...
Java_com_criminal_moscow_gui_DailyReward_init(JNIEnv *env, jobject thiz) {
    CDailyReward::thiz = env->NewGlobalRef(thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_DailyReward_click(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_DailyReward_hide(JNIEnv *env, jobject thiz) {
