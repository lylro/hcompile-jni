...
Java_com_criminal_moscow_gui_donate_Donate_native_1hide(JNIEnv *env, jobject thiz) {
    env->DeleteGlobalRef(CDonate::thiz);
    CDonate::thiz = nullptr;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_donate_Donate_sendAction(JNIEnv *env, jobject thiz, jint action_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_donate_Donate_sendClickItem(JNIEnv *env, jobject thiz, jint action_type,
