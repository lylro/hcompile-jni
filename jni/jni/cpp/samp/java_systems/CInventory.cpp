...
Java_com_criminal_moscow_gui_Inventory_InventoryInit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_Inventory_switchToggle(JNIEnv *env, jobject thiz, jboolean toggle) {
    CInventory::bIsToggle = toggle;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_Inventory_sendSelectItem(JNIEnv *env, jobject thiz, jint matrindex,
                                                    jint pos) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_Inventory_sendClickButton(JNIEnv *env, jobject thiz, jint buttonid) {
    RakNet::BitStream bsSend;
    bsSend.Write((uint8_t)ID_CUSTOM_RPC);
