...
Java_com_criminal_moscow_gui_PreDeath_init(JNIEnv *env, jobject thiz) {
    CMedic::thiz = env->NewGlobalRef(thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_PreDeath_medicMiniGameExit(JNIEnv *env, jobject thiz, jint type_id) {
    CMedic::bIsShow = false;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_PreDeath_medicPreDeathExit(JNIEnv *env, jobject thiz, jint button_id) {
    CMedic::bIsShow = false;
