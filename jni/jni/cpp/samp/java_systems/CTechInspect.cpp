...
//    jstring str = env->NewStringUTF(name);
    ...
    env->CallVoidMethod(CTechInspect::thiz, method, str4, gen, candl, brake, starter, nozzles, price, carid);
...
Java_com_criminal_moscow_gui_TechIspect_init(JNIEnv *env, jobject thiz) {
    CTechInspect::thiz = env->NewGlobalRef(thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_TechIspect_sendClick(JNIEnv *env, jobject thiz)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_TechIspect_exit(JNIEnv *env, jobject thiz) {
    CTechInspect::bIsShow = false;
}
