...
Java_com_criminal_moscow_gui_CasinoBaccarat_sendAddBet(JNIEnv *env, jobject thiz, jint sum,
                                                     jint bettype) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_CasinoBaccarat_init(JNIEnv *env, jobject thiz) {
    CBaccarat::thiz = env->NewGlobalRef(thiz);
    CBaccarat::clazz = env->GetObjectClass(CBaccarat::thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_CasinoBaccarat_exit(JNIEnv *env, jobject thiz) {
    RakNet::BitStream bsSend;
    bsSend.Write((uint8_t)ID_CUSTOM_RPC);
    bsSend.Write((uint8_t)RPC_UPDATE_BACCARAT);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_CasinoBaccarat_close(JNIEnv *env, jobject thiz) {
