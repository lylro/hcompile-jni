...
Java_com_criminal_moscow_gui_Casino_Init(JNIEnv *env, jobject thiz) {
    jCasino = env->NewGlobalRef(thiz);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_Casino_ClickChipButton(JNIEnv *env, jobject thiz, jint button_id,
