...
Java_com_criminal_moscow_gui_Furniture_1factory_InitFurnitureFactory(JNIEnv *env, jobject thiz) {
jFurnitureFactory = env->NewGlobalRef(thiz);
}

JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_Furniture_1factory_SendSucces(JNIEnv *env, jobject thiz,
        jint button_id) {
