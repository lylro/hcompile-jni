...
Java_com_criminal_moscow_gui_MineGame1_Init(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_MineGame2_Init(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_MineGame1_ExitMineGame(JNIEnv *env, jclass clazz, jint exittype) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_criminal_moscow_gui_MineGame3_Init(JNIEnv *env, jobject thiz) {
