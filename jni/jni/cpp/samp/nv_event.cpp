...
static std::queue<NVEvent> g_pEvents;
...
Java_com_nvidia_devtech_NvEventQueueActivity_customMultiTouchEvent(JNIEnv *env, jobject thiz,
                                                                   jint action,
                                                                   jint pointer, jint x1, jint y1,
                                                                   jint x2, jint y2, jint x3,
                                                                   jint y3) {
    ...
    static jfieldID ACTION_POINTER_DOWN_id = env->GetStaticFieldID(KeyCode_class,
                                                                   "ACTION_POINTER_DOWN", "I");
    static jfieldID ACTION_POINTER_UP_id = env->GetStaticFieldID(KeyCode_class, "ACTION_POINTER_UP",
                                                                 "I");

    static jfieldID ACTION_CANCEL_id = env->GetStaticFieldID(KeyCode_class, "ACTION_CANCEL", "I");
    static jfieldID ACTION_POINTER_INDEX_SHIFT_id = env->GetStaticFieldID(KeyCode_class,
                                                                          "ACTION_POINTER_ID_SHIFT",
                                                                          "I");
    static jfieldID ACTION_POINTER_INDEX_MASK_id = env->GetStaticFieldID(KeyCode_class,
    ...
    static int ACTION_POINTER_INDEX_MASK = env->GetStaticIntField(KeyCode_class,
                                                                  ACTION_POINTER_INDEX_MASK_id);
    static int ACTION_POINTER_INDEX_SHIFT = env->GetStaticIntField(KeyCode_class,
                                                                   ACTION_POINTER_INDEX_SHIFT_id);
...

    {
        ...
        ev.m_data.m_multi.m_action =
                (NVMultiTouchEventType) (ev.m_data.m_multi.m_action |
                                         (pointer << NV_MULTITOUCH_POINTER_SHIFT));
