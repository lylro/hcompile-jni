...
extern "C" void sub_11664 (uintptr_t pc)
{
	...
	for (uintptr_t start = pc; start != pc + g_SizeStart_XTEA3; start++)
	{
		if (!memcmp((void*)start, (void*)g_Start_XTEA3, g_SizeStart_XTEA3))
		{
			addr = start;
			break;
		}
	...
	addr += g_SizeStart_XTEA3;

	NOP(addr, g_SizeCode_XTEA3 / 2);
