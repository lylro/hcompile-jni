//
// Created by weikton on 21.06.2025.
//
#include "RQShader.h"
...
void BuildVertexSource(int flags) {
    ...
    if (uVar1 != 0) {
        ...
        if ((int) (flags << 0x12) < 0) {
            ...
            strcat((char *)&vtxbuf, acStack_102c);
            if (((flags & 0x1180) != 0) && (*(int *) (g_libGTASA + 0x8ed870) != 0)) {
    ...
    if (uVar2 != 0) {
        ...
        strcat((char *)&vtxbuf, acStack_102c);
        snprintf(acStack_102c, 0x200, "uniform highp vec4 Bones[%d];", 3 * *(uint32_t *)(g_libGTASA + 0x617248));
        strcat((char *)&vtxbuf, acStack_102c);
    }
    if (uVar7 != 0) {
...
void BuildPixelSource(int flags) {
    ...
    if (uVar4 == 0) {
        ...
        } else if (*(uint8_t *)(g_libGTASA + 0x617250)) {
            snprintf(acStack_102c, 0x200,
    ...
    if ( (flags & 0x1000040) == 1 && (flags & 0x2000) != 0 && !*(uint8_t *)(g_libGTASA + 0x617250) ) {
        uVar3 = uVar1;
        if (uVar1 != 0) {
            uVar3 = flags & 0x2000;
        }
