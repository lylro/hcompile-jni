...
void CCustomServerWindow::Render()
{
	...
	ImGui::Begin("SELECT", nullptr,
		...
		{
			const auto encryptedAddress = cryptor::create("127.0.0.1", 24); unsigned short port = 1392;
		...
		{
			const auto encryptedAddress = cryptor::create("127.0.0.1", 24); unsigned short port = 7776;
