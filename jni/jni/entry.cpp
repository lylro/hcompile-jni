...
void* hack_thread(void* args)
{
	...
	DobbyHook((void *)(CGameAPI::GetBase(xorstr("RakClient::RegisterAsRemoteProcedureCall"))), (void *)&hook_RakClient__RegisterAsRemoteProcedureCall, (void **)&orig_RakClient__RegisterAsRemoteProcedureCall);
