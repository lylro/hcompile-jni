...
public final class FamilyConstants {
    ...
    @NotNull
    public static final FamilyConstants INSTANCE = new FamilyConstants();
    ...
    public static final int MAX_VALUE_OF_REPRIMANDS = 3;
