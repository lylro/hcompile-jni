...
static void DWORD2RGBA(uint32_t dwColor, CRGBA& rgba)
{
...
void CExtendedCarColors::ApplyPatches_level0()
{
	...
	CHook::CHook::UnFuck(g_libGTASA + 0x005CF418);
...
{
#ifdef _CDEBUG
	Log("Returned color %d %d %d %d %d", id, ms_vehicleColourTable[id].A, ms_vehicleColourTable[id].B, ms_vehicleColourTable[id].G, ms_vehicleColourTable[id].R);
#endif
	return ms_vehicleColourTable[id];
}
