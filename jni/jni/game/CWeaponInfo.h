...
public:
	...
	static CWeaponInfo *GetWeaponInfo(unsigned int weaponType, signed char skill);
	// get weapon type by name
	static unsigned int FindWeaponType(char const* name);
	// get weapon fire type by name
	static eWeaponFire FindWeaponFireType(char const* name);
	// initialisation
