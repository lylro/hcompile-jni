...
//    static inline bool& bPickUpcamActivated = *(bool*)0x978620;
 ...
 //   static inline std::array<CPickup, MAX_NUM_PICKUPS> aPickUps;
...
public:
    ...
    static void DoCollectableEffects(CEntityGTA* entity);
    static void DoMineEffects(CEntityGTA* entity);
    static void DoMoneyEffects(CEntityGTA* entity);
    static void DoPickUpEffects(CEntityGTA* entity);

    static CPickup* FindPickUpForThisObject(CObjectGta* object);
