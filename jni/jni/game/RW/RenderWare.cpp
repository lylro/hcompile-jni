...
{
	Log(OBFUSCATE("Initializing BrRenderWare.."));
	...
	CHook::WriteMemory(SA_ADDR(0x1A7EF2), (uintptr_t)"\x4F\xF4\x40\x10\x4F\xF4\x40\x10", 8);
	CHook::WriteMemory(SA_ADDR(0x1A7F34), (uintptr_t)"\x4F\xF4\x40\x10\x4F\xF4\x40\x10", 8);
	CHook::WriteMemory(SA_ADDR(0x1A7ECE), (uintptr_t)"\x4F\xF0\x01\x00\x00\x46", 6);
}