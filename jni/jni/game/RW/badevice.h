...
static_assert(sizeof(RwSubSystemInfo) == 0x50);
...
static_assert(sizeof(RwVideoMode) == 0x10);
...
// Threadsafe���� ���� ���� ���� Thread �̿��� Thread���� ȣ��Ǵ����� ã�� ���� �뵵
...
//@{ 20050513 DDonSS : Threadsafe ó��.. �ܺ� Lock�Լ� ���� �����ϵ��� ���� �߰�
