...
#define HUD_ELEMENT_WIDGETS 	3
#define HUD_ELEMENT_HUD     	4
#define HUD_ELEMENT_VOICE		5
#define HUD_ELEMENT_TEXTLABELS	6
#define HUD_ELEMENT_BUTTONS		7
#define HUD_ELEMENT_KILL_LIST	8
...
#define IN_VEHICLE(x) (x->bInVehicle)
#define IS_CROUCHING(x) (x->bIsDucking)
...
#define LIB_CRASH_OFFSET(offset, value)	*(uint8_t*)(SA_ADDR(0x001800AC + (offset))) = value
...
typedef struct _PED_TYPE
{
    ...
    char                field_485[3];
    int32_t m_nPedState;			// 1096-1100	;Action
	...
	float fUnkRotRel;
    float fRotCamAdjust;
    uintptr_t pContactVehicle; 	// 1384 - 1388
	PADDING(_pad105, 24);		// 1376 - 1420
	...
	PADDING(_pad2811, 20); 				// 1817-1837
	uint8_t byteFightingStyle; 			// 1837-1838
	uint8_t byteFightingType; 			// 1838-1839
	PADDING(_pad280, 1); 				// 1839-1840
