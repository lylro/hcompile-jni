...
void CGame::InitInGame()
{
	...
	//
///	NOP(g_libGTASA + 0x5C121C, 2);
	ApplyInGamePatches();
	InitScripting();
	
	GameResetRadarColors();
	//LogNoLimit("%s", ((char *(*)(unsigned int))(g_libGTASA + 0x001A40B4 + 1))(100));
//	Log("%s\n%s", reinterpret_cast<char*>(*(char* *)(g_libGTASA+0x617290)),
  //  reinterpret_cast<char*>(*(char* *)(g_libGTASA+0x619294)));
...
void CGame::DisableInteriorEnterExits()
{
	...
	Log("CountDisableInteriorEnterExits = %d", count);
