...
public:
	...
	// 0.3.7
	CPlayerPed* FindPlayerPed() { if(!m_pGamePlayer) m_pGamePlayer = new CPlayerPed(/*7, 208, 435, 250, 12, 0*/); /* *(uint8_t*)(g_libGTASA + 0x8E864C) = m_pGamePlayer->m_bytePlayerNumber; */ return m_pGamePlayer; }
	// 0.3.7
