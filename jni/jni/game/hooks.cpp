...
//	}
    ...
    {
//                                    Log(OBFUSCATE("Load zalupa 5 failed: (%s)"), path);
        free(st);
        st = nullptr;
        return 0;
    }
...
//
//    //graphic settings
//    //if(*(int*)(g_libGTASA + 0x985260) != 0x87F40000){ *(int*)(g_libGTASA + 0x985260) = 0x87F40000; } // LOD distance
...
/* ====================================================== */
//void (*LoadCollision)(const char *a1, int a2, const char a3);
//void LoadCollision__hook(const char *a1, int a2, const char a3)
//{
//	Log(OBFUSCATE("Loading: s%.."), a1);
//
...
//                  Log(OBFUSCATE("Load zalupa: 3"));
//                  Log(OBFUSCATE("Loading imgs..."));

//	CStreaming::AddImageToList(OBFUSCATE("TEXDB\\CUTSCENE.IMG"), true);
...
{
    NvUtilInit();
    *(char**)(g_libGTASA + 0x5D1608) = OBFUSCATE("/storage/emulated/0/BenzoSamp/");
}
...
// int64_t** (*RQIndexBuffer__SetSafe)(int64_t **result);
// int64_t** RQIndexBuffer__SetSafe_hook(int64_t **result)
// {
//   int64_t v1; // kr00_8
//   int64_t ES2IndexBuffer__curCPUBuffer; // r2
//   uintptr_t *ES2IndexBuffer__curCPUSize; // r4

//   v1 = **result;
//   ES2IndexBuffer__curCPUBuffer = *(*result + 1);
//   ES2IndexBuffer__curCPUSize = (uintptr_t *)(g_libGTASA + 0x617220);
//   *(uintptr_t *)(g_libGTASA + 0x617224) = ES2IndexBuffer__curCPUBuffer;
//   *ES2IndexBuffer__curCPUSize = v1;
//   *result = (int64_t *)((char *)ES2IndexBuffer__curCPUBuffer + v1);
//   return result;
// }
...
void (*CWaterLevel__RenderWater)(uintptr_t *thiz);
void CWaterLevel__RenderWater_hook(uintptr_t *thiz){

    *(uintptr_t *)(g_libGTASA + 0x61572C) |= 0x1000000;

    CWaterLevel__RenderWater(thiz);

    *(uintptr_t *)(g_libGTASA + 0x61572C) &= ~0x1000000;
}

void (*CVehicle__Render)(uintptr_t* thiz, int a2, int a3, int a4);
void CVehicle__Render_hook(uintptr_t* thiz, int a2, int a3, int a4)
{

    *(uintptr_t *)(g_libGTASA + 0x61572C) |= 0x800000000;

    CVehicle__Render(thiz, a2, a3, a4);
...
//extern uintptr_t g_ES2Shader;
//extern uintptr_t g_RQShader;
//extern char* byte_617290;
//extern char* byte_619294;
//extern uintptr_t* g_emuCustomShader;
//void GetTexture_waterDUDV();
//int ResetEnvMap(int a1);
//uintptr_t BuildShaderSource(uintptr_t a1, const char *a2, const char *a3, int a4);
//void BuildPixelSource_hook(uintptr_t flags);
//void BuildVertexSource_hook(uintptr_t flags);
//int (*emu_glEndInternal)();
//int emu_glEndInternal_hook()
//{
//
//    uintptr_t i = g_ES2Shader;
//
...
//                //"\tgl_FragColor = textureCube(CubeEnvMap, Out_Refl);\n"
...
//                0x1002422);
//
//        ((int (*)(uintptr_t , int))(g_libGTASA + 0x1984A5))(i, 1);
//
//        //==========================================================================================
//
//        //BuildShaderSource(
...
////
//        //((int (*)(uintptr_t , int))(g_libGTASA + 0x1984A5))(i, 1);
//    }/*else if((*(uintptr_t *)(g_libGTASA + 0x61572C))){
//        //==========================================================================================
//
//        BuildPixelSource_hook(*(uintptr_t *)(g_libGTASA + 0x61572C));
//        BuildVertexSource_hook(*(uintptr_t *)(g_libGTASA + 0x61572C));
//
//        BuildShaderSource(
//                i,
//                byte_617290,
//                byte_619294,
//                *(uintptr_t *)(g_libGTASA + 0x61572C));
//
//        ((int (*)(uintptr_t , int))(g_libGTASA + 0x1984A5))(i, 1);
//    }*/
//    int ret = emu_glEndInternal();
//    uintptr_t result = *(uintptr_t *)(g_libGTASA + 0x61572C) << 12;
//    if ( ((*(uintptr_t *)(g_libGTASA + 0x61572C)) & 0x80000) != 0 )
//    {
//
//
...
//void RwCameraClear1(int a1, uintptr_t *a2, uintptr_t *a3, int a4, int a5, int a6);
//int sub_6F048(uintptr_t *thiz)
//{
//    //uintptr_t v0; // r0
//    unsigned int v1; // r4
//    int v2; // r0
//    int v3; // r3
//    int result; // r0
//    int settings_WaterReflLvl = 3; // rUGHUR
//
//    //v0 = *(uintptr_t *)g_libGTASA;
//    if ( *(uintptr_t *)(g_libGTASA + 0x63E464) )     // reflections level
//    {
//        ((void (*)(uintptr_t*))(g_libGTASA + 0x54DE1D))(thiz);// CMirrors::CreateBuffer(CMirrors *this)
//        //v0 = *(uintptr_t *)g_libGTASA;
//    }
//    v1 = *(uintptr_t*)(g_libGTASA + 0x63E464);
//    if ( v1 >= 2 )
//        RwCameraClear1(0x800000, *(uintptr_t**)(g_libGTASA + 0x9B4CD0), *(uintptr_t**)(g_libGTASA + 0x9B4CD4), v1 == 2, 0, v1 == 3);
//    v3 = settings_WaterReflLvl;
//    if ( v3 >= 1 )                                // water reflections level
//    {
//        if ( v3 != 1 )
//            v3 = 0;
//        RwCameraClear1(0x8800000, *(uintptr_t**)dword_748C98, *(uintptr_t**)dword_748C9C, v3, 0, 0);
//        if ( settings_WaterReflLvl >= 3 )
//        {
//            RwCameraClear1(0, *(uintptr_t**)dword_748C90, *(uintptr_t**)dword_748C94, 0, 0, 0);// 2 arg is g_waterDuDvTex
//        }
//    }
//    result = 1;
//    if ( result ){
//        RwCameraClear1(0, *(uintptr_t**)dword_748C88, *(uintptr_t**)dword_748C8C, 0, 1, 0);
//        return 0;
//    }
//
//    return result;
...
//
//void sub_6F15C(){
//    dword_748C88 = RwRasterCreate(256, 256, 32, 1285);
//    dword_748C90 = RwRasterCreate(256, 256, 32, 1285);
//    dword_748C98 = RwRasterCreate(256, 256, 32, 1285);
//    dword_748C94 = RwRasterCreate(256, 256, 0, 1);
//    //g_WaterDuDvTex = RwRasterCreate(256, 256, 0, 1);
//    dword_748C9C = RwRasterCreate(256, 256, 0, 1);
//    dword_748C8C = RwRasterCreate(256, 256, 0, 1);
//}
//uint8_t byte_67DF80 = 0;
...
//        sub_6F048(thiz);
//        Log("CMirrors__RenderReflections_hook state: 2");
//        return /*CMirrors__RenderReflections(thiz)*/;
//    }
//
//    sub_6F15C();
//
...
//    return /*CMirrors__RenderReflections(thiz)*/;
//
//    Log("CMirrors__RenderReflections_hook state: 1");
//}
//
...
void InstallHooks()
{
    ...
    //SetUpHook(g_libGTASA + 0x525C28, (uintptr_t)CWaterLevel__RenderWater_hook, (uintptr_t*)&CWaterLevel__RenderWater);
    //SetUpHook(g_libGTASA + 0x51AAE4, (uintptr_t)CVehicle__Render_hook, (uintptr_t*)&CVehicle__Render);
