...
int mainDec() {
    ...
    char data2[] = "/data/data/com.twilightmoscow.game/lib/libbass.so";
    char data3[] = "/storage/emulated/0/TwilightMoscow/files/";
...
{	
	NvUtilInit();
	*(char**)(g_libGTASA + 0x5D1608) = OBFUSCATE("/storage/emulated/0/TwilightMoscow/files/");
}
