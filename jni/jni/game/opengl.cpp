...
void SetUpGLHooks()
{
	...
	installHook(SA_ADDR(0x1A40B4), (uintptr_t) BuildPixelSource_hook, (uintptr_t *) &BuildPixelSource);
	installHook(SA_ADDR(0x1A4AB4), (uintptr_t) BuildVertexSource_hook, (uintptr_t *) &BuildVertexSource);
}