...
uint16_t CPad__GetPedWalkLeftRight_hook(uintptr_t thiz)
{
	...
	{
		if (pNetGame->GetPlayerPool()->GetLocalPlayer()->GetPlayerPed()->GetLockControllable() == true)
		{
			// Remote player
...
void HookCPad()
{
	...
	installHook(SA_ADDR(0x39C9E4), (uintptr_t) CPad__GetSteeringLeftRight_hook, (uintptr_t *) &CPad__GetSteeringLeftRight);
