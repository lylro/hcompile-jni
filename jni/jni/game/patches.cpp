...
void ApplyPatches_level0()
{
    ...
    //CHook::RET("_ZN8CVehicle15DoVehicleLightsER7CMatrixj");

    /*CHook::NOP(g_libGTASA + (VER_x32 ? 0x2AB4A6 : 0x36A190), (VER_x32? 2 : 1));//map back button
    //CHook::NOP(g_libGTASA + (VER_x32 ? 0x2AB4EA : 0x00), (VER_x32? 2 : 1));//map shadow

    CHook::RET("_ZN10MenuScreen8DrawBackEb");
    CHook::RET("_ZN10MenuScreen8DrawQuadE9CVector2DS0_P5CRGBA");
    CHook::RET("_ZN10MenuScreen10DrawSliderE9CVector2DS0_fbhb");
    CHook::RET("_ZN10MobileMenu10DrawSpriteEP9RwTextureP9CVector2DS3_P5CRGBA");
    CHook::RET("_ZN10MobileMenu10DrawSpriteEP9RwTexture5CRGBA9CVector2DS3_");
    CHook::RET("_ZN10MobileMenu10DrawSpriteEP9RwTexture5CRGBA9CVector2DS3_S3_S3_");
    CHook::RET("_ZN10MenuScreen10DrawSpriteEP9RwTexture5CRGBA9CVector2DS3_S3_S3_");
    CHook::RET("_ZN10MenuScreen14DrawTextDirectEPt9TextAligni5CRGBAb9CVector2DS3_bPi");*/
...
void ApplyGlobalPatches()
{
    ...
    // CRadar::DrawEntityBlip (translate color) // у вейктона просто спиздел а вейктон у плаки или х.1.2.
