...
{
	                  /* 250 mb + Flame fps fix */
    WriteMemory(g_libGTASA + 0x52DD38, (uintptr_t)"\x00\x20\x70\x47", 4); // Render
    makeNOP(g_libGTASA + 0x39AD14, 1); // Render effects (+ hooks.cpp)
    memcpy((uint32_t*)(g_libGTASA+0x5DE734), "0x10000000", 10); // 250 MB
