...
void ApplyPatches_level0()
{
	...
	*/
	...
	/*
	//optimizite by gor grygoryan
	WriteMemory(g_libGTASA + 0x570B00 + 52, (uintptr_t)"      ", 6);
	WriteMemory(g_libGTASA + 0x570B40 + 52, (uintptr_t)"      ", 6);
	WriteMemory(g_libGTASA + 0x570C74 + 75, (uintptr_t)"      ", 6);
	WriteMemory(g_libGTASA + 0x570B58 + 53, (uintptr_t)"      ", 6);
	WriteMemory(g_libGTASA + 0x570BC8 + 46, (uintptr_t)"      ", 6);
	*/
...
void ApplyPatches()
{
    ...
    makeNOP(g_libGTASA + 0x2661DA, 2); // Display - Shadows (���� ��� �� ���� �����)
  ...
  sub_45A32(dword_14A458 + 0x2DC8E0, nullsub_39, 2);
	...
	*/
	...
	WriteMemory(g_libGTASA + 0x458D68, (uintptr_t)"\x00\x46\x00\x46", 4); // cFire::extinguish nopped
