...
public:
    ...
    void SetLockTogglePlayerControllable(bool bToggle);
    void SetTogglePlayerControllable(bool bToggle, bool isServer);
    void UpdateTogglePlayerControllable();
	...
	void SetWaitAnimationGunFlash(bool value);
...
public:
	...
	bool 				m_bWaitAnimationGunFlash;
	uint8_t				m_bPlayerInterior;

    bool 				m_bLockTogglePlayerControllable;
