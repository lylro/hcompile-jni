...
const SCRIPT_COMMAND set_actor_attack_actor = { 0x07A5, "iii" };
const SCRIPT_COMMAND task_kill_char_on_foot = { 0x05E2, "ii" };
const SCRIPT_COMMAND task_char_slide_to_coord = { 0x07CD, "ifffff" };
