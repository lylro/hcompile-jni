...
const SCRIPT_COMMAND create_player = { 0x0053, "vfffv" };	// 0, x, y, z, PLAYER_CHAR
const SCRIPT_COMMAND get_player_coordinates = { 0x00A0, "ivvv" };	// PLAYER_CHAR, varX, varY, varZ
const SCRIPT_COMMAND create_actor_from_player = { 0x01F5, "vv" };		// PLAYER_CHAR, PLAYER_ACTOR
...
const SCRIPT_COMMAND load_texture_to_sprite = { 0x038F, "is" };
const SCRIPT_COMMAND create_sphere = { 0x03BC, "ffffv" };
const SCRIPT_COMMAND remove_sphere = { 0x03BD, "v" };
const SCRIPT_COMMAND set_cloth = { 0x087B, "issi" };

const SCRIPT_COMMAND is_char_touching_vehicle = { 0x0547, "ii" };
const SCRIPT_COMMAND is_char_touching_object = { 0x0179, "ii" };
const SCRIPT_COMMAND attach_char_to_car = { 0x0464, "iifffifi" };
const SCRIPT_COMMAND is_char_swimming = { 0x00965, "i" };