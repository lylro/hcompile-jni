...
void LoadSplashTexture()
{
    ...
    CHUD::hud_radar = (RwTexture*)LoadTextureFromDB("samp", "hud_back");
    //CHUD::hud_radar2 = (RwTexture*)LoadTextureFromDB("samp", "micro_icon");
}
...
void RenderBackgroundHud()
{
        if (CHUD::hud_radar)
        {//183 55.. 399..33
            ImGui::GetBackgroundDrawList()->AddImage((ImTextureID)CHUD::hud_radar->raster,
