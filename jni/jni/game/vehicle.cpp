...
void CVehicle::CreateExhaust(VEHICLE_TYPE* a1) {
    float v7 = 0.0f, v8 = 0.0f, v14 = 0.0f;
    int v3 = (int)(m_pVehicle->pHandling->m_bDoubleExhaust);
    
    uintptr_t *dwModelArray2 = (uintptr_t*)(g_libGTASA + 0x87BF48);
    
    if (dwModelArray2[m_pVehicle->entity.nModelIndex]) {
        uintptr_t modelInfo = dwModelArray2[m_pVehicle->entity.nModelIndex];
        v7 = *(float *)(*(uintptr_t *)(modelInfo + 0x74) + 0x48);
        v8 = *(float *)(*(uintptr_t *)(modelInfo + 0x74) + 0x4C);
        v14 = *(float *)(*(uintptr_t *)(modelInfo + 0x74) + 0x50) - 1.65f;
    }

    VECTOR vecLeft = {v7, v8, v14};
    VECTOR vec = {0.0f, 0.0f, 180.0f};
