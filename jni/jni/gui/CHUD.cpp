...
HUD_SELECT CHUD::m_iHud = CHUD_NOP;
  ...
  /*  if(m_iHud == CHUD_ONE)
    ...
    {   
     ...
     /*   ImVec2 generalPos(v46, v45);
        ...
        if(fHungry > 100.0f) fHungry = 100.0f;
        ...
        char buff[0x30]; sprintf(buff, "%d", iCountMoney);
    ...
    if(!pGame->FindPlayerPed()->IsInVehicle()) return;
