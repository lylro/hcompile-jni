...
public:
    ...
    void drawRect(const ImVec2& a, const ImVec2& b, const ImColor& color, bool fill, float thickness = 1.0f, float radius = 0.0f);
    void drawRoundedRect(const ImVec2& a, const ImVec2& b, const ImColor& color, float rounding, bool fill = false, float thickness = 1.0f);
