...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
	"{D5713F}|{FFFFFF} Подключение GOOD RUSSIA...",
	"{00541F}|{FFFFFF} Вход в игру",
	"{FF0000}|{FFFFFF} Сервер закрыл соеденение, перезайдите",
	"{FF0000}|{FFFFFF} Некоторые файлы были модифированы, переустановите клиент",
	"unused",
	"{FF0000}|{FFFFFF} Вы были заблокированы сервером",
	"{FF0000}|{FFFFFF} Потеряно соеденение с сервером, переподключение...",
	"{FF0000}|{FFFFFF} Проблемы с сетью, переподключение...",
	"{FF0000}|{FFFFFF} Сервер полон"
};
