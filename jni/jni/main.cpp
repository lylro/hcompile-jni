...
#include "main.h"
#include "a_weikton_serversetter.h"
#include "game/game.h"
...
void InitSAMP(JNIEnv* pEnv, jobject thiz)
{
	...
	g_pszStorage = "/storage/emulated/0/GoodRussia/";
...
void InitInGame()
{
	...
	if (!bGameInited)
	{
		...
		pGame->SetMaxStats();
                                    ...
                                    // МЕНЯТЬ В a_weikton_serversetter.h
		pNetGame = new CNetGame(WEIKTON_HOST, WEIKTON_PORT, pSettings->GetReadOnly().szNickName, pSettings->GetReadOnly().szPassword);
