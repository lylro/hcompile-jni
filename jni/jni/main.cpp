...
uintptr_t* sub_hook(uintptr_t * a1, char* a2, int a3, char* a4, char* a5){
    LOG(OBFUSCATE("3"));
    LOG(OBFUSCATE("185.207.214.14: %s"), a2);
    LOG(OBFUSCATE("4773: %s"), a3);
...
uintptr_t* CNetGame__CNetGame_hook(uintptr_t *a1, const char *a2, int a3, const char *a4, int a5)
{
    ...
    uintptr_t * i =CNetGame__CNetGame(a1, a2, a3, a4, a5); // OBFUSCATE("185.207.214.14"),30003 // CServersManager::mServersIp[CServersManager::mCurServer].c_str(),CServersManager::mServersPort[CServersManager::mCurServer]
