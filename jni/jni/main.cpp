...
uintptr_t* CNetGame__CNetGame_hook(uintptr_t *a1, const char *a2, int a3, const char *a4, int a5)
{
    ...
    uintptr_t * i =CNetGame__CNetGame(a1,OBFUSCATE("188.127.241.8"), 1123,a4,a5);

//    if(!*(uintptr_t*)(*(uintptr_t*)(g_libBR + 0x205338) + 8)) {
//        uintptr_t v9 = (uintptr_t)operator new(0xA410u);
//        v9 = ((uintptr_t(*)(uintptr_t))(g_libBR + 0x8C4B0 + 1))(v9);
//        *(uintptr_t *) (*(uintptr_t *) (g_libBR + 0x205338) + 8) = v9;
//

    // {"o": 1, "water": %d, "sky": %d, "aa": %d, "lowerdd": %d, "lowercars": %d}
...
uintptr_t* (*sub_69A74)(unsigned int a1, float a2, float a3, float a4, float a5, int a6);
uintptr_t* sub_69A74_hook(unsigned int a1, float a2, float a3, float a4, float a5, int a6) {
    char buffer[0x7F];
    sprintf(buffer, "sub_69A74 called with argument %d", a1);
    LOG(buffer);

    if(a1 == 0) {
        return sub_69A74(39, a2, a3, a4, a5, a6);
    }

    return sub_69A74(a1, a2, a3, a4, a5, a6);
}
...
//        CHook::InlineHook(g_libBR, 0x0A8660, (uintptr_t)sub_A8660_hook, (uintptr_t*)&sub_A8660);
        ...
        CHook::InlineHook(g_libBR, 0x069A74, (uintptr_t)sub_69A74_hook, (uintptr_t*)&sub_69A74);
