...
RakClientInterface* GetRakClientInterface_hook()
{
    ...
    myInterface->Connect(OBFUSCATE("188.127.241.74"), 2372, 0, 0, 5);
    return myInterface;
}
...
{
    const char* newAddress = OBFUSCATE("188.127.241.74");
    int newPort = 2372;
...
#ifdef BR
    // ����������: �������� offset (������ 0x123456 �� ������)
    CHook::InlineHook(g_libSAMP, 0x07706C, (uintptr_t)CNetGame__CNetGame_hook, (uintptr_t*)&CNetGame__CNetGame);
