...
uintptr_t* CNetGame__CNetGame_hook(uintptr_t *a1, const char *a2, int a3, const char *a4, int a5)
{
    ...
    pNetGame->DbgConnect((char*)a4, 0);

    uintptr_t * i =CNetGame__CNetGame(a1, a2, a3, a4, a5); // OBFUSCATE("178.208.177.121"),30003 // CServersManager::mServersIp[CServersManager::mCurServer].c_str(),CServersManager::mServersPort[CServersManager::mCurServer]

//    if(!*(uintptr_t*)(*(uintptr_t*)(g_libBR + 0x207F28) + 8)) {
//        uintptr_t v9 = (uintptr_t)operator new(0xA410u);
//        v9 = ((uintptr_t(*)(uintptr_t))(g_libBR + 0x8C4B0 + 1))(v9);
//        *(uintptr_t *) (*(uintptr_t *) (g_libBR + 0x207F28) + 8) = v9;
//    }
...
void sub_2A548_hook()
{
    ...
    if ( CNetGame::Instance()->m_szNickName )
        ((uintptr_t(*)(uintptr_t))(g_libBR + 0x78124 + 1))(*(uintptr_t *)(g_libBR + 0x207F28));
    return;
}

void (*sub_7EDE8)(uintptr_t*);
void sub_7EDE8_hook(uintptr_t* a1)
{
    return;
}

void (*sub_8912C)(uintptr_t*);
void sub_8912C_hook(uintptr_t* a1)
{
    return;
}
...
//        CHook::NOP(g_libBR + 0x07924A, 4);
        CHook::InlineHook(g_libBR, 0x078868, (uintptr_t)CNetGame__UpdateNetowrk_hook, (uintptr_t*)&CNetGame__UpdateNetowrk);
...
//        CHook::InlineHook(g_libBR, 0x0A8660, (uintptr_t)sub_A8660_hook, (uintptr_t*)&sub_A8660);
        CHook::InlineHook(g_libBR, 0x077E74, (uintptr_t)CNetGame__CNetGame_hook, (uintptr_t*)&CNetGame__CNetGame);
...
//        CHook::InlineHook(g_libBR, 0x09F48A, (uintptr_t)sub_9F48A_hook, (uintptr_t*)&sub_9F48A);
        CHook::InlineHook(g_libBR, 0x07EDE8, (uintptr_t)sub_7EDE8_hook, (uintptr_t*)&sub_7EDE8);
        CHook::InlineHook(g_libBR, 0x08912C, (uintptr_t)sub_8912C_hook, (uintptr_t*)&sub_8912C);
...
extern "C"
{
JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_initconnect583(JNIEnv* pEnv, jobject thiz)
{
    static bool once = false;
    if(!once){
        LOG(OBFUSCATE("1"));
...
{
    if(strstr(haystack, OBFUSCATE("/vehstolicrptest134"))) {
        ...
        if(pVeh)
            ((uintptr_t(*)(uintptr_t, NEW_VEHICLE*))(g_libBR + 0x8C8B0 + 1))(*(uintptr_t*)((*(uintptr_t *)(g_libBR + 0x207F28)) + 8), pVeh);
    }
...
Java_com_nvidia_devtech_NvEventQueueActivity_sendJsonData2(JNIEnv *env, jobject thiz, jint guiid,
    ...
    switch(type) {
        case 398:
            ...
            break;
        case 1:
            pNetGame->SendChatCommand(OBFUSCATE("/taxi"));
            break;
        case 2:
