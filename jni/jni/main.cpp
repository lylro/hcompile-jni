...
#include "weikton/Connector.h"
#include "weikton/CMessages.h"
...
void InitInGame()
{
	...
	if (!bGameInited)
	{
		...
		CPlayerPed *pPlayer = pGame->FindPlayerPed();
	                  ...
	                  pCamera->SetPosition(217.2077f, 820.7957f, 32.9233f, 0.0f, 0.0f, 0.0f);
	                  pCamera->LookAtPoint(216.5356f, 820.0491f, 32.8333f, 2);
