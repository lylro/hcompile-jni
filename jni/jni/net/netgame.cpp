...
void CNetGame::Process()
{
	...
	else
	{
		...
		{                                  
				...
				pPlayer->RemoveFromVehicleAndPutAt(-1790.879638, 739.463317, 35.294849);
			else
				pPlayer->TeleportTo(-1787.404052, 738.588928, 35.244380);
			...
			pGame->ToggleRadar(false);
                        ...
                        pGame->NewVehicle(415, -1785.404052, 738.588928, 35.244380, 0, false); 
                 }
