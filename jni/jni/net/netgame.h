...
public:
    ...
    static void packetFamily(Packet *p);
	static void packetEmployment(Packet *p);
	static void packetMarket(Packet *p);
	static void packetCraft(Packet *p);
	static void packetRoulette(Packet *p);
	static void packetEdit(Packet *p);
	static void packetRecon(Packet *p);
	static void packetAzs(Packet *p);
	static void packetAdminTools(Packet *p);
	static void packetContainer(Packet *p);
	static void packetFishing(Packet *p);
	static void packetBattlePass(Packet *p);
	static void packetNewBattlePass(Packet *p);
	static void packetTuning(Packet *p);
	static void packetCasino(Packet *p);
	static void packetInventory(Packet *p);
	static void packetDialogs(Packet *p);
	static void packetTrade(Packet *p);
	static void packetDonate(Packet *p);
	static void packetShop(Packet *p);
	static void packetBinders(Packet *p);
	static void packetChat(Packet *p);
	static void packetQuests(Packet *p);
	static void packetNewBieBattle(Packet *p);
	static void packetAuthReg(Packet *p);
	static void packetNoty(Packet *p);
	static void packetPlates(Packet *p);
	static void packetSpawn(Packet *p);
	static void packetBusiness(Packet *p);
	static void packetAction(Packet *p);
	static void packetActor(Packet *p);
private:
