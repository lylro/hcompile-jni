...
#define RPC_DONATE_CLICK 100
#define RPC_DONATE_BUY 101
#define RPC_DONATE_SHOW 42
#define RPC_DONATE_UPDATE 43
...
public:
	...
	static void packetDonateShow(Packet* p);

	static void packetDonateUpdate(Packet* p);
};