...
public:
	...
	void UseInventory(int id, int slot);
	void DeleteInventory(int id, int slot);
	void ClickInventory(int id);
	...
	static void packetFamilyShow(Packet* p);
	static void packetFamilyLoadCar(Packet* p);
	static void packetFamilyLoadNotif(Packet* p);
	static void packetFamilyLoadRaiting(Packet* p);

	static void packetFamilyInfoMainMenu(Packet* p);

	static void packetFamilyLoadPlayers(Packet* p);
	static void packetFamilyLoadRangCar(Packet* p);
	static void packetFamilyLoadPlayerInfo(Packet* p);

	static void packetLoadRangName(Packet* p);

	static void packetFamilyAccessRang(Packet* p);

	static void packetFamilyInfoStock(Packet* p);
