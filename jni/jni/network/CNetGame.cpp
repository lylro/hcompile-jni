...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE(host, serverPort, clientPort, depreciated, threadSleepTimer); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("195.18.27.241");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("host, serverPort, clientPort, depreciated, threadSleepTimer); // Sasuke
}
