...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("141.94.184.110"), 1385, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("141.94.184.110");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("141.94.184.110", 1385, 0, 0, 0); // Sasuke
}
