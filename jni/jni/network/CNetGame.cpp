...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("айпи"),порт, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("айпи");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("141.95.234.21", 1649, 0, 0, 0); // Sasuke
    // @wellpoper888
}
