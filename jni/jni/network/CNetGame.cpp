...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("195.18.27.241"), 2874, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("65.108.99.34");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("195.18.27.241", 2874, 0, 0, 0); // Sasuke
}
