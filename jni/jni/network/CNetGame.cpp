...
#include "scripting.h"
#include "systems/CServersManager.h"
...
// {
//    m_rakClientInterface->Connect((char*)OBFUSCATE("//188.127.241.8"), 1472, 0, 0, 5); // Сервер 1
//    m_rakClientInterface->Connect((char*)OBFUSCATE("//188.127.241.74"), 1246, 0, 0, 0); // Сервер 2
 //   m_rakClientInterface->Connect((char*)OBFUSCATE("//192.168.1.100"), 1472, 0, 0, 3); // Сервер 3
    
   //  m_szHostOrIp = (char*)OBFUSCATE("5.39.108.48");
...
void CNetGame::DbgConnect(char* nickname)
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("80.242.59.112"), 3321, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("80.242.59.112");
    m_szNickName = nickname;
   m_rakClientInterface->Connect("185.189.255.97", 2807, 0, 0, 0); // Sasuke
}
...
void Packet_SyncGUI(Packet* packet) {
    ...
    char log[0x7F];
    sprintf(log, "RPCID: %d", rpcID);
    LOG(log);

    if (rpcID == 99) {
        uintptr_t result;
        uint16_t dataLen, guiID;

        bitStream.Read(guiID);
        bitStream.Read(dataLen);

        char data[dataLen + 1];
        bitStream.Read(data, dataLen);

        data[dataLen] = '\0';

        ((uintptr_t (*)(uintptr_t*, char*)) (g_libBR + 0x190218 + 1))(&result, data);
        ((uintptr_t (*)(uintptr_t*, int, uintptr_t *)) (g_libBR + 0x08D9F6 + 1))(*(uintptr_t**)(g_libBR + 0x7BEE6C), guiID, &result); // gotovo
    } else if (rpcID == 100) {
        CSettingsLoader* cSettingsLoader = new CSettingsLoader();

        uintptr_t result;

        char data[0x7F];
        sprintf(data, "{\"o\": 1, \"water\": %d, \"sky\": %d, \"aa\": %d, \"lowerdd\": %d, \"lowercars\": %d}", cSettingsLoader->water, cSettingsLoader->sky, cSettingsLoader->aa, cSettingsLoader->lowerdd, cSettingsLoader->lowercars);

        ((uintptr_t (*)(uintptr_t*, char*)) (g_libBR + 0x190218 + 1))(&result, data);
        ((uintptr_t (*)(uintptr_t*, int, uintptr_t *)) (g_libBR + 0x08D9F6 + 1))(*(uintptr_t**)(g_libBR + 0x7BEE6C), 19, &result);
    } else if (rpcID == 101) {
        uintptr_t i;
        bitStream.Read(i);
        ...
        switch (i) {
            case 1: {
                sprintf(buffer1, "%sSAMP/handling-comfort.cfg", (char*)(g_libBR + 0x207F14));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E100 + 1))(buffer1);
            }
            case 2: {
                sprintf(buffer1, "%sSAMP/handling-drift.cfg", (char*)(g_libBR + 0x207F14));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E100 + 1))(buffer1);
            }
            case 3: {
                sprintf(buffer1, "%sSAMP/handling-sport.cfg", (char*)(g_libBR + 0x207F14));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E100 + 1))(buffer1);
            }
            case 4: {
                sprintf(buffer1, "%sSAMP/handling-plus.cfg", (char*)(g_libBR + 0x207F14));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E100 + 1))(buffer1);
            }
        }
    }
...
Java_com_nvidia_devtech_NvEventQueueActivity_sendReJsonData(JNIEnv *env, jobject thiz, jint guiid, jbyteArray data) {
    jsize length = env->GetArrayLength(data);
    jbyte* byteArray = env->GetByteArrayElements(data, nullptr);

    char cData[length];
    memcpy(cData, byteArray, length);

    RakNet::BitStream bsSend;
    bsSend.Write((uint8_t) 251);
    bsSend.Write((uint8_t) guiid);

    uint16_t len = static_cast<uint16_t>(length);
    bsSend.Write(len);
    bsSend.Write(cData, len);

    CNetGame::Instance()->m_rakClientInterface->Send(&bsSend, SYSTEM_PRIORITY, RELIABLE_SEQUENCED, 0);
...
//    if(*(uint8_t*)(g_libGTASA + 0x5D1B24) != g_pCurActivePlayer){ *(uint8_t*)(g_libGTASA + 0x5D1B24) = g_pCurActivePlayer; }
    ...
    if ( !*(uintptr_t*)(g_libBR + 0x7BC624) )
        *(uintptr_t*)(g_libBR + 0x7BC624) = GetTickCount();
...
//        }
        ...
        while (1) {
            ...
            if (v9 == 40)
                v9 = v8[5];
            *(uintptr_t *) (g_libBR + 0x7BC624) = GetTickCount();
            LOG(OBFUSCATE("CNetGame | packet Id : %i"), v9);
            switch (v9) {
                case 200:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x0798E0 + 1))(a1,
                                                                                    (uintptr_t *) v2);
                    goto LABEL_80;
                case 201:
                case 202:
                ...
                case 251:
                    ...
                    goto LABEL_80;
                case 203:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x07A0C8 + 1))(a1,
                                                                                     (uintptr_t *) v2);
                    goto LABEL_80;
                case 206:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x07A168 + 1))(a1,
                                                                                     (uintptr_t *) v2);
                    goto LABEL_80;
                case 207:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x07967C + 1))(a1,
                                                                                     (uintptr_t *) v2);
                    goto LABEL_80;
                case 208:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x079F8C + 1))(a1,
                                                                                     (uintptr_t *) v2);
                    goto LABEL_80;
                case 209:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x079D24 + 1))(a1,
                                                                                     (uintptr_t *) v2);
                    goto LABEL_80;
                case 210:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x079B7C + 1))(a1,
                                                                                     (uintptr_t *) v2);
                    goto LABEL_80;
                case 211:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x079EF4 + 1))(a1,
                                                                                    (uintptr_t *) v2);
                    goto LABEL_80;
                case 252:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x07A20C + 1))(a1,
                                                                                    (uintptr_t *) v2);
                    goto LABEL_80;
                case 253:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x07A37C + 1))(a1,
                                                                                    (uintptr_t *) v2);
                    goto LABEL_80;
                default:
                    switch (v9) {
...
//                else if ( !*(char*)g_libBR + 0x7BC632 ){*(char*)(byte_7BC633) = 0;*(char*)(g_libBR + 0x7BC630) = 0;LABEL_78:*(char*)(g_libBR + 0x7BC632) = 1;goto LABEL_79;}
                            ...
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DAF4 + 1))(
                                    *(uintptr_t **) (g_libBR + 0x207F2C), 0xBEBEBEFF, v3);
                        LABEL_79:
                            a1[10] = 9;
                        LABEL_80:
...
//                            v2 = pPacket;
                        ...
                        case 31:
                            v10 = v3;
                            //((uintptr_t(*)(uintptr_t*, uintptr_t, char))(g_libBR + 0x1DAF4))(*(uintptr_t**)g_libBR + 0x207F2C, 0xBEBEBEFF, *(char*)(g_libBR + 0x1CF74C));
                            a1[10] = 9;
                            ...
                            *(char *) (byte_7BC633) = 10;
                            ...
                            if (!v14 && !*(char *) (g_libBR + 0x7BC620)) {
                                ...
                                if (!((int (*)(uintptr_t, uintptr_t)) (g_libBR + 0x04461C))(
                                    ...
                                    ((uintptr_t(*)(uintptr_t, uintptr_t, int)) (g_libBR + 0x043C40))(
                                ...
                                ((uintptr_t(*)(uintptr_t *, ...)) (
                                        g_libBR + 0x055814 + 1))(&*(uintptr_t *) g_libBR + 0x1D6D9E,
                                                                 *(uintptr_t *) g_libBR + 0x201EDC, 1, 1, 1,
                                                                 1, 1);
                                v18 = *(uintptr_t *) g_libBR + 0x201EDC;
                                v19 = lrand48() % 256;
                                v20 = lrand48();
                                ((uintptr_t(*)(uintptr_t *, ...)) (
                                        g_libBR + 0x055814 + 1))(&*(uintptr_t *) g_libBR + 0x1D6DB0, v18,
                                ...
                                ((uintptr_t(*)(uintptr_t *, ...)) (
                                        g_libBR + 0x055814 + 1))(&*(uintptr_t *) g_libBR + 0x1D6DC2,
                                                                 *(uintptr_t *) (v23 + 8),
                                                                 *(uintptr_t *) g_libBR + 0x201EDC, v21,
                                                                 v34, v36, v38);
                                ...
                                ((uintptr_t(*)(uintptr_t, char *)) (g_libBR + 0x190218))(
                                        (uintptr_t) &v39, v10);
                                ((uintptr_t(*)(uintptr_t, int, uintptr_t *)) (g_libBR + 0x08D9F6))(v26,
                                                                                                   39,
                                                                                                   (uintptr_t *) &v39);
                                v27 = (void *) (v39 - 12);
                                if ((uintptr_t *) (v39 - 12) != &*(uintptr_t *) (g_libBR + 0x7E7E40)) {
                            ...
                            goto LABEL_80;
                        case 32:
//                            if (*(uintptr_t *) (g_libBR + 0x207F2C))
//                                //((uintptr_t(*)(uintptr_t, uintptr_t, uintptr_t))(g_libBR + 0x01DAF4))(*(uintptr_t*)g_libBR + 0x207F2C, 0xBEBEBEFF, *(uintptr_t*)g_libBR + 0x1CF8F2);
...
//                                        *(uintptr_t *) g_libBR + 0x609F68);
                            goto LABEL_80;
                        case 33:
//                            ((uintptr_t(*)(uintptr_t *)) (g_libBR + 0x07931C))(a1);
                            goto LABEL_80;
                        case 34:
                        ...
                        case 35:
                            ((uintptr_t(*)(uintptr_t, char *)) (g_libBR + 0x01DA3C))(
                                    *(uintptr_t *) (g_libBR + 0x207F2C),
                                    (char *) OBFUSCATE("Failed to initialize encryption."));
                            goto LABEL_80;
                        case 36:/*((uintptr_t(*)(uintptr_t,uintptr_t,char*))(g_libBR + 0x01DAF4))(*(uintptr_t*)g_libBR + 0x207F2C, 0xBEBEBEFF, (char *)*(uintptr_t*)g_libBR + 0x79064);*/
                            goto LABEL_80;
                        case 37:
//                            ((uintptr_t(*)(uintptr_t, char *)) (g_libBR + 0x01DA3C))(
//                                    *(uintptr_t *) g_libBR + 0x207F2C,
