...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.127.241.8"), 1569, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("188.127.241.8");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("188.127.241.8", 1569, 0, 0, 0); // Sasuke
}
                ...
                default:
                    switch (v9) {
                        case 12:
                            ...
                            goto LABEL_80;
                        case 29:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("Нет срединения с сервером. Попробуйте использовать VPN и перезайти в игру. Если не помгло сервер выключен"));
...
//                            ((uintptr_t(*)(uintptr_t*, uintptr_t, char*))(g_libBR + 0x1DACC))(*(uintptr_t**)g_libBR + 0x20533C, 0xBEBEBEFF, "test message disconnect");
                        ...
                        case 33:
                            ...
                            goto LABEL_80;
                        case 34:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("Соединено. Подготовка к игре..."));
