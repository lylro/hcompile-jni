...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.127.241.74:4881"), 4881, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("5.39.108.48");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("188.127.241.74:4881", 4881, 0, 0, 0); // Sasuke
}
...
void Packet_SyncGUI(Packet* packet) {
    ...
    if (rpcID == 99) {
        ...
        ((uintptr_t (*)(uintptr_t*, char*)) (g_libBR + 0x18ED08 + 1))(&result, data);
        ((uintptr_t (*)(uintptr_t*, int, uintptr_t *)) (g_libBR + 0x08CC5E + 1))(*(uintptr_t**)(g_libBR + 0x7FB444), guiID, &result);
    } else if (rpcID == 100) {
        ...
        ((uintptr_t (*)(uintptr_t*, char*)) (g_libBR + 0x18ED08 + 1))(&result, data);
        ((uintptr_t (*)(uintptr_t*, int, uintptr_t *)) (g_libBR + 0x08CC5E + 1))(*(uintptr_t**)(g_libBR + 0x7FB444), 19, &result);
    } else if (rpcID == 101) {
        uintptr_t i;
        ...
        switch (i) {
            case 1: {
                sprintf(buffer1, "%sSAMP/handling-comfort.cfg", (char*)(g_libBR + 0x205324));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E0D8 + 1))(buffer1);
            }
            case 2: {
                sprintf(buffer1, "%sSAMP/handling-drift.cfg", (char*)(g_libBR + 0x205324));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E0D8 + 1))(buffer1);
            }
            case 3: {
                sprintf(buffer1, "%sSAMP/handling-sport.cfg", (char*)(g_libBR + 0x205324));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E0D8 + 1))(buffer1);
            }
            case 4: {
                sprintf(buffer1, "%sSAMP/handling-plus.cfg", (char*)(g_libBR + 0x205324));
                ((uintptr_t (*)(char*)) (g_libBR + 0x01E0D8 + 1))(buffer1);
            }
        }
    }
...
//        }
        ...
        while (1) {
            v8 = v2->data;
            v9 = v8[0];
            LOG("test zalupa bobra: %d", v9);
            if (v9 == 40) v9 = v8[5];
            *(uintptr_t *) (g_libBR + 0x7F8C00) = GetTickCount();

            switch (v9) {
                case 200:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x078948 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 201:
                case 202:
                case 204:
                ...
                case 251:
                    ...
                    goto LABEL_80;
                case 203:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x079130 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 206:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x0791D0 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 207:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x0786E4 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 208:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x078FF4 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 209:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x078D8C + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 210:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x078BE4 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 211:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x078F5C + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 252:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x079274 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                case 253:
                    ((uintptr_t(*)(uintptr_t *, uintptr_t *)) (g_libBR + 0x0793E4 + 1))(a1, (uintptr_t *) v2);
                    goto LABEL_80;
                default:
                    switch (v9) {
                        case 12:
                            ...
                            goto LABEL_80;
                        case 29:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("����������� ����������. ��� �������: ���������� ������������� ������, ���� ������� ��������, ���� ��������������� VPN"));
                            goto LABEL_80;
                        LABEL_80:
                        ...
                        case 31:
                            v10 = v3;
//                            ((uintptr_t(*)(uintptr_t*, uintptr_t, char*))(g_libBR + 0x1DACC))(*(uintptr_t**)g_libBR + 0x20533C, 0xBEBEBEFF, "test message disconnect");
                            a1[10] = 9;
                        ...
                        case 32:
                            ...
                            if (*(uintptr_t *) g_libBR + 0x207F40) {
                                ((uintptr_t(*)(uintptr_t)) (g_libBR + 0x09C72C))(*(uintptr_t *) g_libBR + 0x207F40);
                            }
                            if (*(uintptr_t *) g_libBR + 0x609F68) {
                                ((uintptr_t(*)(uintptr_t)) (g_libBR + 0x04006C))(*(uintptr_t *) g_libBR + 0x609F68);
                            }
                            goto LABEL_80;
                        case 33:
                                ((uintptr_t(*)(uintptr_t *)) (g_libBR + 0x078314 + 1))(a1);
                            goto LABEL_80;
                        case 34:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("���������. ���������� � ����..."));
                        ...
                        case 36:/*((uintptr_t(*)(uintptr_t,uintptr_t,char*))(g_libBR + 0x01DACC))(*(uintptr_t*)g_libBR + 0x20533C, 0xBEBEBEFF, (char *)*(uintptr_t*)g_libBR + 0x79064);*/
                            goto LABEL_80;
                        case 37:
                            ((uintptr_t(*)(uintptr_t, char *)) (g_libBR + 0x01DA3C))(*(uintptr_t *) g_libBR + 0x20533C, (char *) OBFUSCATE("Wrong server password"));
