...
void CNetGame::DbgConnect(char* nickname)//185.207.214.14:5073
{
    m_rakClientInterface->Connect(pSettings->GetReadOnly().host, pSettings->GetReadOnly().port, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)pSettings->GetReadOnly().host;
        ...
        while (1) {
            ...
            *(uintptr_t *) (g_libBR + 0x7F8C00) = GetTickCount();
            ...
            switch (v9) {
                ...
                case 250:
                case 251:
                    CRegerdsRPC::Packet_SyncCustomRPC(v2);
                case 203:
