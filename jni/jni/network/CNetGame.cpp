...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.165.138.225"), 1253, 0, 0, 5); 
    m_szHostOrIp = (char*)OBFUSCATE("188.165.138.225");
                ...
                default:
                    switch (v9) {
                        case 12:
                            ...
                            goto LABEL_80;
                        case 29:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("Потеряно соединение с сервером, попробуйте проверить состояние сети или воспользуйтесь VPN."));
                            goto LABEL_80;
                        LABEL_80:
