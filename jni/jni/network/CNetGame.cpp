...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.165.6.206"), 1381, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("188.165.6.206");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("188.165.6.206", 1381, 0, 0, 0); // Sasuke
}
