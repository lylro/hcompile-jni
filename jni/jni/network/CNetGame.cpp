...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("141.95.190.144"), 1129, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("141.95.190.144");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("141.95.190.144", 1129, 0, 0, 0); // Sasuke
}
