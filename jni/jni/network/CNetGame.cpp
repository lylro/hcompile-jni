...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("5.39.108.51"), 1169, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("5.39.108.51");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("5.39.108.51", 1169, 0, 0, 0); // Sasuke
}
