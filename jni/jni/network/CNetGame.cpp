...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("185.189.255.97"), 3005, 0, 0, 5); // ЗАМЕНЯЙ ТУТ
    m_szHostOrIp = (char*)OBFUSCATE("185.189.255.97");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("141.94.184.106", 1285, 0, 0, 0); // И ТУТ
}
