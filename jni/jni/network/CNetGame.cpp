...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("51.75.232.69"), 1225, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("51.75.232.69");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("51.75.232.69", 1225, 0, 0, 0); // Sasuke
}
