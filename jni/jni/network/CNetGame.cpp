...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.127.241.74"), 2760, 0, 0, 5); 
                ...
                default:
                    switch (v9) {
                        ...
                        case 33:
                            ...
                            goto LABEL_80;
                        case 34:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("Вы подключились. Подготовка к игре..."));
