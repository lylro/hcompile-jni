...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.127.241.8"), 1469, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("188.127.241.8");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("188.127.241.8", 11469, 0, 0, 0); // Sasuke
}
