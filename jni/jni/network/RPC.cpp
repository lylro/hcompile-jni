...
//    }
    ...
    char buffer[0x7F];
    sprintf(buffer, "NewVehicle.VehicleID = %d");
...
//    CHook::NOP(g_libBR + 0x07C674, 4);
    ...
    pRakClient->RegisterAsRemoteProcedureCall(&(*(int *)(g_libBR + 0x204C48)), ((void (*)(RPCParameters*))(g_libBR + 0x7AB6C + 1)));
    ...
    pRakClient->RegisterAsRemoteProcedureCall(&(*(int *)(g_libBR + 0x204D90)), ((void (*)(RPCParameters*))(g_libBR + 0x8266C + 1)));
