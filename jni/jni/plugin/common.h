...
enum BRPacketEnumeration : int32_t
{
    ...
    BR_ID_AIM_SYNC = 0x6, //
    BR_ID_WEAPONS_UPDATE = 0xB, //
    BR_ID_STATS_UPDATE = 0x8, //
    BR_ID_PASSENGER_SYNC = 0x5, //
    BR_ID_TRAILER_SYNC = 0xA, //
    BR_ID_PLAYER_SYNC = 0x9, //
    BR_ID_UNOCCUPIED_SYNC = 0x2, //
    BR_ID_SPECTATOR_SYNC = 0x7, //
    BR_ID_BULLET_SYNC = 0xC, //
    BR_ID_VEHICLE_SYNC = 0x3, //
    BR_ID_TURNLIGHTS_SYNC = 0x4, //
    BR_ID_USER_PACKET_ENUM = 0xD,
    BR_ID_CONNECTION_ATTEMPT_FAILED = 0x14, //
    BR_ID_DISCONNECTION_NOTIFICATION = 0x12, //
    BR_ID_NO_FREE_INCOMING_CONNECTIONS = 0x16, // 
    BR_ID_CONNECTION_REQUEST_ACCEPTED = 0x17, //
    BR_ID_TIMESTAMP = 0x13, //
    BR_ID_PONG = 0x18, //
    BR_ID_CONNECTION_BANNED = 0x19, //
    BR_ID_CONNECTION_LOST = 0x11, //
    BR_ID_MODIFIED_PACKET = 0x15, //
    BR_ID_NEW_INCOMING_CONNECTION = 0x10, //
    BR_ID_INVALID_PASSWORD = 0x1A, //
    BR_ID_QUEUE_UPDATE = 0x1AF,
    BR_ID_QUEUE_LEFT = 0x1AL,
    BR_ID_RPC = 0x1D, //
    BR_ID_DETECT_LOST_CONNECTIONS = 0x22, //
    BR_ID_OPEN_CONNECTION_REPLY = 0x26, //
    BR_ID_CONNECTED_PONG = 0x1E, //
    BR_ID_PING_OPEN_CONNECTIONS = 0x21, //
    BR_ID_AUTH_KEY = 0x23, //
    BR_ID_PING = 0x1F, //
    BR_ID_INTERNAL_PING = 0x20, //
    BR_ID_OPEN_CONNECTION_REQUEST = 0x24, //
    BR_ID_CONNECTION_REQUEST = 0x25, //
    BR_ID_REQUEST_STATIC_DATA = 0x27, //
    BR_ID_SECURED_CONNECTION_RESPONSE = 0x28, //
    BR_ID_SECURED_CONNECTION_CONFIRMATION = 0x29, //
    BR_ID_RPC_MAPPING = 0x2A, //
    BR_ID_RPC_REPLY = 0x2B, //
    BR_ID_BROADCAST_PINGS = 0x2C, //
    BR_ID_SET_RANDOM_NUMBER_SEED = 0x2D, //
    BR_ID_RSA_PUBLIC_KEY_MISMATCH = 0x2E, //
    BR_ID_RECEIVED_STATIC_DATA = 0x2F, //
    BR_ID_REMOTE_DISCONNECTION_NOTIFICATION = 0x30, //
    BR_ID_REMOTE_CONNECTION_LOST = 0x31, //
    BR_ID_REMOTE_NEW_INCOMING_CONNECTION = 0x32, //
    BR_ID_REMOTE_EXISTING_CONNECTION = 0x33, //
    BR_ID_REMOTE_STATIC_DATA = 0x34, //
    BR_ID_ADVERTISE_SYSTEM = 0x355, //
    BR_ID_OPEN_CONNECTION_COOKIE = 0x35, //
};
...
enum BRRpcIds : int32_t
{
    ...
    BR_RPC_ScrPlaySound = 0x171, //
    BR_RPC_SetVehicleParamsEx = 0x152,
    BR_RPC_ObjectCollision = 0x1AC,
    BR_RPC_ScrSelectTextDraw = 0x154,
    BR_RPC_DialogResponse = 0x202, // мб не верный
    ...
    BR_RPC_MapMarker = 0x13D, // мб не тот ид
    ...
    BR_RPC_VehicleDestroyed = 0x1F6, // мб не верный
    BR_RPC_WorldPlayerAdd = 0x151,
    BR_RPC_ScrStopFlashGangZone = 0x13F,
  ...
  //  BR_RPC_ScrCustomizeVehicle = 0xA7,
    ...
    BR_RPC_PlayerGiveTakeDamage = 0x185, //
