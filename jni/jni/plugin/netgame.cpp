...
void CNetGame::Packet_CustomRPC(Packet *p) {
    ...
    switch (rpcID) {
       case 38: 
	   {
           ...
           case 2: 
	   {
		    CChat::AddDebugMessage("FUELFIL");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowFuel(jsonString); 
	   ...
	   case 45: 
	   {
		    CChat::AddDebugMessage("family");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowFamily(jsonString);
	   ...
	   case 33: 
	   {
		    CChat::AddDebugMessage("inv");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowInventory(jsonString);
	   ...
	   case 29: 
	   {
		    CChat::AddDebugMessage("tune");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowTuning(jsonString);
	   ...
	   case 22: 
	   {
		    CChat::AddDebugMessage("DONATE");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowDonate(jsonString);
	   ...
	   case 46: 
	   {
		    CChat::AddDebugMessage("FRACTION");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowFraction(jsonString);
            ...
            case 71: 
	   {
		    CChat::AddDebugMessage("KMONARCH");
			uint32_t length;
			bs.Read(length); 
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); 
			
				pJavaWrapper->ShowCalendar(jsonString); 
           ...
           case 69: // айди гуи 
	   {
		    CChat::AddDebugMessage("GIFTS");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowGifts(jsonString); 
           ...
           case 56:
	   {
		    CChat::AddDebugMessage("ELECTRIK");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowElectric(jsonString); 
           ...
           case 27: 
	   {
		    CChat::AddDebugMessage("RADIAL");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowRadialMenu(jsonString); 
           ...
           case 73:  
	   {
		    CChat::AddDebugMessage("CASEKMONARCH");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowCases(jsonString); 
           ...
           case 74: 
	   {
		    CChat::AddDebugMessage("REWARD");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowBpRewards(jsonString); 
           ...
           case 66: 
	   {
		    CChat::AddDebugMessage("CPECK");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowAdminTools(jsonString); 
            ...
            case 77: 
	   {
		    CChat::AddDebugMessage("MARKET");
			uint32_t length;
			bs.Read(length); // Читаем длину строки
			std::string jsonString(length, '\0');
			bs.Read(&jsonString[0], length); // Чтение строки
			
				pJavaWrapper->ShowMarketplace(jsonString); 
