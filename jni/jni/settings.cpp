...
void CSettings::Save(int iIgnoreCategory)
{
	...
	ini_table_create_entry_as_float(config, "client", "jblvolume", m_Settings.fjblVolume);
...
void CSettings::LoadSettings(const char* szNickName, int iChatLines)
{
	...
	m_Settings.fjblVolume = ini_table_get_entry_as_float(config, "client", "jblvolume", 1.0f);
