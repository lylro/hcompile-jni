...
void CSettings::Save(int iIgnoreCategory)
{
	...
	//ini_table_create_entry(config, "bylaird", "iplaird", m_Settings.iplaird); // host
	//ini_table_create_entry_as_int(config, "bylaird", "portlaird", m_Settings.portlaird); // port
...
void CSettings::LoadSettings(const char* szNickName, int iChatLines)
{
	...
	// load host and port
	//const char* host = ini_table_get_entry(config, "bylaird", "iplaird"); // host
	//if (host) strcpy(m_Settings.iplaird, host);
	//m_Settings.portlaird = ini_table_get_entry_as_int(config, "bylaird", "portlaird", -1); // port
