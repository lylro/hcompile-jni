...
//    }
    ...
    if(bOnce){
        for (int i = 0; i < a2; ++i) {
            CServersManager::mServersIp[i] = OBFUSCATE("185.207.214.14");
            CServersManager::mServersPort[i] = 1725;
        }
    }else{
        CServersManager::mServersIp[0] = OBFUSCATE("185.207.214.14");
        CServersManager::mServersPort[0] = 1725;
        CServersManager::mServersIp[1] = OBFUSCATE("185.207.214.14");
        CServersManager::mServersPort[1] = 1725;
        // ...
    }
