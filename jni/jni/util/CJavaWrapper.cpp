...
extern "C"
{
			...
			case 1:
				switch(action) {
					...
					case 7:
						...
						break;
					case 8:
						pNetGame->SendChatCommand("/hudeditor");		
						break;	
                                        case 9:
				...
				case 3:
				    switch(action) {
					    case 0: {
					        pNetGame->SendChatCommand("/autosalon 0");
					        pChatWindow->AddDebugMessage("buy");
					        break;
					    }
					    case 1:
					        pNetGame->SendChatCommand("/autosalon 1");
					         break;
					    case 2:
					        pNetGame->SendChatCommand("/autosalon 2");
					        break;
					   case 3:
					        pNetGame->SendChatCommand("/autosalon 3");
					        break;
					   case 4:
					        pNetGame->SendChatCommand("/autosalon 4");
					        break;
					}
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendRPC2(JNIEnv* pEnv, jobject thiz, jint type, jbyteArray str, jint action)
	{
				    switch(action) {
					    case 0: {
					        pNetGame->SendChatCommand("/autosalon 0");
					   ...
					   case 4:
					        ...
					        break;
					    case 5:
					        pNetGame->SendChatCommand("/autosalon 5");
					        break;
					}	
	}

	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_onClickButton(JNIEnv* pEnv, jobject thiz, jint button)
	{
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openAppInTablet(JNIEnv* pEnv, jobject thiz, jint app)
	{
		char cmd[16];
		sprintf(cmd, "/tablet %d", app);
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_setNativeOnlineInHud(JNIEnv* pEnv, jobject thiz, jboolean b)
	{
		if (pSettings)
		{
			...
			{
				/*(uint8_t*)(g_libGTASA+0x7165E8) =*/ 1;
				g_pJavaWrapper->Hideonlone();
			}
			else
			{
				/*(uint8_t*)(g_libGTASA+0x7165E8) =*/ 0;
				g_pJavaWrapper->Showonline();
			}
		}
	}
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_setNativeHudTime(JNIEnv* pEnv, jobject thiz, jboolean b)
	{
		if (pSettings)
		{
			pSettings->GetWrite().iHudTime = b;
			if(!b)
			{
				/*(uint8_t*)(g_libGTASA+0x7165E8) =*/ 1;
				g_pJavaWrapper->HideTimeData();
			}
			else
			{
				/*(uint8_t*)(g_libGTASA+0x7165E8) =*/ 0;
				g_pJavaWrapper->ShowTimeData();
			}
		}
	}
	...
	JNIEXPORT jboolean JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_getNativeHudTime(JNIEnv* pEnv, jobject thiz)
	{
		if (pSettings)
		{
			return pSettings->GetReadOnly().iHudTime;
		}
		return 0;
	}
...
void CJavaWrapper::ShowMenucar()
{
    ...
    env->CallVoidMethod(this->activity, this->s_showMenucar);
}

void CJavaWrapper::HideMenucar()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_hideMenucar);
}
void CJavaWrapper::ShowRadialka()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showRadialka);
}

void CJavaWrapper::HideRadialka()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_hideRadialka);
}


void CJavaWrapper::Showonline()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_Showonline);
}

void CJavaWrapper::Hideonlone()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_Hideonlone);
}

void CJavaWrapper::HideTimeData()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_HideTimeData);
}

void CJavaWrapper::ShowTimeData()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_ShowTimeData);
}


void CJavaWrapper::upDatesaint(int health, int armour, int hunger, int weaponid, int ammo, int ammoinclip, int money, int wanted )
{
	JNIEnv* env = GetEnv();
	...
	env->CallVoidMethod(this->activity, this->s_upDatesaint, health, armour, hunger, weaponid, ammo, ammoinclip, money, wanted);
}
...
void CJavaWrapper::ShowAutoSalon()
{
    ...
    pChatWindow->AddDebugMessage("dkd");
    ...
    env->CallVoidMethod(this->activity, this->s_showSalon);
}
...
void CJavaWrapper::HideAutoSalon()
{
    ...
    env->CallVoidMethod(this->activity, this->s_hideSalon);
}

void CJavaWrapper::SetCarInAutosalon(int price, char* name)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_setCarinAutoSalon, str1, price);
}

void CJavaWrapper::HideButtons()
{
	JNIEnv* env = GetEnv();
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
	...
	s_upDatesaint = env->GetMethodID(nvEventClass, "upDatesaint", "(IIIIIIII)V");
    s_showHud = env->GetMethodID(nvEventClass, "showHud", "()V");
    s_hideHud = env->GetMethodID(nvEventClass, "hideHud", "()V");
	
	s_Showonline = env->GetMethodID(nvEventClass, "Showonline", "()V");
	s_Hideonlone = env->GetMethodID(nvEventClass, "Hideonlone", "()V");
	
	s_ShowTimeData = env->GetMethodID(nvEventClass,"ShowTimeData", "()V");
	s_HideTimeData = env->GetMethodID(nvEventClass,"HideTimeData", "()V");
    ...
    s_hideSpeed = env->GetMethodID(nvEventClass, "hideSpeed", "()V");
		s_showRadialka = env->GetMethodID(nvEventClass, "showRadialka", "()V");
    s_hideRadialka = env->GetMethodID(nvEventClass, "hideRadialka", "()V");
		s_showMenucar = env->GetMethodID(nvEventClass, "showMenucar", "()V");
    s_hideMenucar = env->GetMethodID(nvEventClass, "hideMenucar", "()V");

	s_setPauseState = env->GetMethodID(nvEventClass, "setPauseState", "(Z)V");
	
	s_showSalon = env->GetMethodID(nvEventClass, "ShowAutosalon", "()V");
	s_hideSalon = env->GetMethodID(nvEventClass, "HideAutosalon", "()V");




	s_setCarinAutoSalon = env->GetMethodID(nvEventClass, "SetCarAutosalon", "(Ljava/lang/String;I)V");
	
	s_showButton = env->GetMethodID(nvEventClass, "ShowButtons", "()V");
	s_hideButton = env->GetMethodID(nvEventClass, "hideButtons", "()V");
