...
class CJavaWrapper
{
	...
	jmethodID s_showSpec;
	jmethodID s_showName;
...
public:
   ...
   void HideHudAndLogo();
	...
	void ShowSpec(int toplayer);
	void ShowName(char* player_name);
	void ShowTabWindow();
	...
	void ShowTaxi(int id, int num, int cash, int price, int rast, float marks);
