...
class CJavaWrapper
{
	...
	jmethodID s_CallLauncherActivity;
                  ...
                  jmethodID s_RadarBR;
jmethodID s_showdead;
jmethodID s_updatedead;
jmethodID s_hidedead;
jmethodID s_showbp;
jmethodID s_showplate;
jmethodID s_showdiner;
...
jmethodID s_showshopfamily;
jmethodID s_showcarfamily;
jmethodID s_showsettingsfamily;
...
jmethodID s_showdriving;
	...
	jmethodID s_showFuelStation;
        jmethodID s_showTabWindoww;
	jmethodID s_setTabStatt;
...
void ShowInventory(int playerlevel);
...
void ShowDriving(int id);
	...
	void ShowFuelStation(int type, int price1, int price2, int price3, int price4, int price5, int maxCount);
        ...
        void ShowTabWindowww();
	void SetTabStattt(int id, char* name, int score, int ping);
        void ShowJbl();
        void ShowPreDeath();
...
void ShowDiner();
void showDead();
void updatenameDead(char* name);
void HideDead();

void ShowFraction(int id);

void ShowSpawnLocation();
void HideSpawnLocation();
...
void ShowPerson();
	void HidePerson();
void ShowFamily(char* name, char* mask, char* money);
void ShowShopFamily(char* name);
void ShowCarFamily(char* name, char* item, int vehid, int access, bool isspawn);
void ShowSettingsFamily(char* name, int f_money, int f_material, int f_ammo);
