...
public:
	...
	static void ShowHud();
	static void HideHud();
	static void UpdateDataHud(int iHP, int iArmour, int iHunger, int iWanted, int iWeapon, int iAllAmmo, int iAmmo, int iMoney, int iEventCoins, int iDonate, bool bEventUsed, bool bGZ, bool bE2y);
