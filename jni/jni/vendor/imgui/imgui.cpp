...
{
    Alpha                   = 1.00f;             // Global alpha applies to everything in ImGui
    WindowPadding           = ImVec2(6,4);      // Padding within a window
    WindowRounding          = 7.25f;             // Radius of window corners rounding. Set to 0.0f to have rectangular windows
    ...
    ChildRounding           = 12.0f;             // Radius of child window corners rounding. Set to 0.0f to have rectangular child windows
    ChildBorderSize         = 1.0f;             // Thickness of border around child windows. Generally set to 0.0f or 1.0f. Other values not well tested.
    PopupRounding           = 0.0f;             // Radius of popup window corners rounding. Set to 0.0f to have rectangular child windows
    PopupBorderSize         = 1.0f;             // Thickness of border around popup or tooltip windows. Generally set to 0.0f or 1.0f. Other values not well tested.
    FramePadding            = ImVec2(8,8);      // Padding within a framed rectangle (used by most widgets)
    FrameRounding           = 1.00f;             // Radius of frame corners rounding. Set to 0.0f to have rectangular frames (used by most widgets).
    ...
    ScrollbarRounding       = 1.0f;             // Radius of grab corners rounding for scrollbar
