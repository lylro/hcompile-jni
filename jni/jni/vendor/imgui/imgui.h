...
namespace ImGui
{
	...
	IMGUI_API void          PushClipRectWithCorners(ImVec2 topLeft, ImVec2 topRight, ImVec2 bottomRight, ImVec2 bottomLeft, bool intersect_with_current_clip_rect);
    // Focus, Activation
...
IMGUI_API void  PushClipRectWithCorners(ImVec2 topLeft, ImVec2 topRight, ImVec2 bottomRight, ImVec2 bottomLeft, bool intersect_with_current_clip_rect = false);	// Render-level scissoring. This is passed down to your render function but not used for CPU-side coarse clipping. Prefer using higher-level ImGui::PushClipRect() to affect logic (hit-testing and widget culling)
