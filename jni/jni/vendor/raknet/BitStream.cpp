...
extern "C"
JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_setServer(JNIEnv* pEnv, jobject thiz, jint connect)
 	{
          pNetGame = new CNetGame(
					g_sEncryptedAddresses[connect].decrypt(),
					g_sEncryptedAddresses[connect].getPort(),
