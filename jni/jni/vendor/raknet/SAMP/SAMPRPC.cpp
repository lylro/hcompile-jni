...
int RPC_ScrToggleWidescreen = 111;
...
int RPC_ScrRemoveBuilding = 43;
int RPC_ScrSetObjectMaterial = 84;
int RPC_ScrSelectTextDraw = 83;
int RPC_ScrSetVehicleTireStatus = 98;
int RPC_ScrSetArmedWeapon = 67;
int RPC_ScrSetActorFacingAngle = 175;
int RPC_ScrSetActorPos = 176;
int RPC_ScrSetActorHealth = 178;
int RPC_ScrPlayAudioStream = 41;
int RPC_ScrStopAudioStream = 42;
