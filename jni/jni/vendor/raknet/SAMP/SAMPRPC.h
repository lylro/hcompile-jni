...
extern int RPC_SetPlayerChatBubble;
...
extern int RPC_ScrDestroy3DTextLabel;
...
extern int RPC_ModePlayer;
extern int RPC_ModeSettings;
extern int RPC_ModeBinder;
extern int RPC_CustomHash;
extern int RPC_CInfo;
extern int RPC_BattlePass;
extern int RPC_VoiceChat;
extern int RPC_HudManager;
extern int RPC_PlayAudioStreams;
extern int RPC_Donate;
extern int RPC_Trade;
extern int RPC_Inventory;
extern int RPC_Tuning;
extern int RPC_Family;
extern int RPC_Finger;
extern int RPC_Apple;
extern int RPC_Binary;
extern int RPC_Roulette;
extern int RPC_CustomSpawn;
extern int RPC_Action;
extern int RPC_RadialMenu;
extern int RPC_RentMenu;
extern int RPC_ShopManager;
extern int RPC_ValentineManager;
extern int RPC_BoatsManager;
extern int RPC_JackpotManager;
extern int RPC_WheelManager;
extern int RPC_QuestManager;
extern int RPC_E2yManager;
extern int RPC_MobileClient;
//extern int RPC_DailyBonus;
extern int RPC_Fraction;
extern int RPC_Parking;
extern int RPC_Market;
extern int RPC_Craft;
extern int RPC_PlayerRoulette;
extern int RPC_EditManager;
extern int RPC_ReconManager;
extern int RPC_AzsManager;
extern int RPC_AdminManager;
extern int RPC_ContainerManager;
extern int RPC_FishingManager;
extern int RPC_CasinoDice;
extern int RPC_SelectorDialog;
extern int RPC_ChatMessage;
extern int RPC_Binders;
extern int RPC_BindersChar;
extern int RPC_VehicleDistance;
extern int RPC_NewBieBattle;
extern int RPC_AuthReg;
extern int RPC_TouchZone;
extern int RPC_Plates;
extern int RPC_Business;