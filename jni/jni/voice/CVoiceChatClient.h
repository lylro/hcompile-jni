...
private:
	...
	int m_StatusMute[MAX_PLAYERS_VOICE];
	bool m_bRecording;
	...
	int m_bVolume[MAX_PLAYERS_VOICE];
	bool m_PlayerVoiceStatus[MAX_PLAYERS_VOICE];
	int m_GlobalVolume;
...
public:
	...
	int StatusMutePlayer(int iPlayerID);
	void SetVolumePlayer(int iPlayerID, int iVolume);
	void SetVolume(int iVolume);
	int GetVolumePlayer(int iPlayerID);
	int GetVolume();
	
	void SetPlayerVoiceStatus(int iPlayerID, bool status);
	bool GetPlayerVoiceStatus(int iPlayerID);
