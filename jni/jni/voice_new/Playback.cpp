...
void Playback::Tick() noexcept
{
    ...
    position.x = TheCamera.m_vecGameCamPos.x;
    position.y = TheCamera.m_vecGameCamPos.y;
    position.z = TheCamera.m_vecGameCamPos.z;

    BASS_Set3DPosition(&position, nullptr, nullptr, nullptr);
    //FLog("Set3DPosition (playback)");
    BASS_Apply3D();
    //FLog("Apply3DPosition (playback)");
}
