...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.127.241.74"), 2372, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("188.127.241.74");
    m_szNickName = nickname;
    /m_rakClientInterface->Connect("188.127.241.74", 2372, 0, 0, 0); // Sasuke
}
                ...
                default:
                    switch (v9) {
                        case 12:
                            ...
                            goto LABEL_80;
                        case 29:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("Не удалось подключиться к серверу попробуйте VPN или перезагрузите вайфай роутер!"));
                            goto LABEL_80;
                        LABEL_80:
...
//                            ((uintptr_t(*)(uintptr_t*, uintptr_t, char*))(g_libBR + 0x1DACC))(*(uintptr_t**)g_libBR + 0x20533C, 0xBEBEBEFF, "test message disconnect");
                        ...
                        case 33:
                            ...
                            goto LABEL_80;
                        case 34:
                            ((uintptr_t(*)(uintptr_t *, uintptr_t, char *)) (g_libBR + 0x01DACC + 1))(*(uintptr_t **) (g_libBR + 0x20533C), 0xBEBEBEFF, OBFUSCATE("Переподключение через 15 секунд..."));
