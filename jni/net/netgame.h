...
public:
	...
	void SendDiner(int price, int eat);
	void SendFamShop(int id, int cost);
	void SendUluchClick(int id);
	void SendQuestClick(int qid);
	void SendTaxiClick(int id);
	...
	void SendShopStoreClick(int id);
