...
bool CVehiclePool::New(NEW_VEHICLE *pNewVehicle)
{
	...
	switch (random)
	{
		...
		case 1:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "c235me", "39");
			break;
		}
		case 2:
		{
		...
		case 3:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "a825op", "52");
			break;
		}
		case 4:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "e285ee", "52");
			break;
		}
		case 5:
		{
		...
		case 8:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "a782ee", "51");
			break;
		}
		case 9:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "e158ee", "52");
			break;
		}
		case 10:
		{
			CCustomPlateManager::PushPlate(pNewVehicle->VehicleID, 1, "m518pp", "52");
			break;
		}
	}
