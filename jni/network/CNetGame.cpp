...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("141.95.234.21"),1373, 0, 0, 5); // ЗАМЕНЯЙ ТУТ
    m_szHostOrIp = (char*)OBFUSCATE("141.95.234.21");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("141.95.234.21", 1373, 0, 0, 0); // И ТУТ
}
