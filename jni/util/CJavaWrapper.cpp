...
JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendRPC(JNIEnv* pEnv, jobject thiz, jint type, jbyteArray str, jint action)
{
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_onEventBackPressed(JNIEnv* pEnv, jobject thiz)
	{
	 ...
	 JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_clicktaxi(JNIEnv* pEnv, jobject thiz, jint id)
	{
		pNetGame->SendTaxiClick(id);
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_FamClickSetting(JNIEnv *env, jobject thiz, jint id) 
    {
	        switch (id) {
				case 2: pNetGame->SendChatCommand("/familyprav"); break;
				case 4: pNetGame->SendChatCommand("/uluchfam"); break;
				case 5: pNetGame->SendChatCommand("/famcar"); break;
				case 6: pNetGame->SendChatCommand("/famlogs"); break;
				case 7: pNetGame->SendChatCommand("/blackfam"); break;
				case 8: pNetGame->SendChatCommand("/fleave"); break;
				case 9: pNetGame->SendChatCommand("/famsklad"); break;
				case 10: pNetGame->SendChatCommand("/famsklad"); break;
				case 11: pNetGame->SendChatCommand("/fsettings"); break;
				case 12: pNetGame->SendChatCommand("/setfcolor"); break;
				case 13: pNetGame->SendChatCommand("/finfo"); break;

			}
    }
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendDiner(JNIEnv *env, jobject thiz, jint price, jint eat)
                  {
                      pNetGame->SendDiner(price, eat);
                  }
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_FamClickUluch(JNIEnv *env, jobject thiz, jint id) 
    {
	        pNetGame->SendUluchClick(id);
    }
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_FamClickQuest(JNIEnv *env, jobject thiz, jint qid) 
    {
	        pNetGame->SendQuestClick(qid);
    }
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_FamClickShop(JNIEnv *env, jobject thiz, jint id, jint cost) 
    {
	        pNetGame->SendFamShop(id, cost);
    }
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_SendClickFraction(JNIEnv* pEnv, jobject thiz)
	{
		pNetGame->SendChatCommand("/show_fraction_quest");
	}
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendRadialClick(JNIEnv* pEnv, jobject thiz, jint id)
	{
        ...
        switch (id) {
            ...
            case 15: pNetGame->SendChatCommand("/drift"); break;
            case 16: pNetGame->SendChatCommand("/comfort"); break;
            case 17: pNetGame->SendChatCommand("/sportplus"); break;
            case 18: pNetGame->SendChatCommand("/sport"); break;
        }
	}
        ...
        JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendHuddeClick(JNIEnv* pEnv, jobject thiz, jint id)
	{
        switch (id) {
            ...
            case 1: pNetGame->SendChatCommand("/notif"); break;
            case 2: pNetGame->SendChatCommand("/bp"); break;
        }
	}
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_SetRadarPos(JNIEnv* env, jobject thiz, jfloat x1, jfloat y1)
	{
		CHUD::radarPos.x1 = x1;
		CHUD::radarPos.y1 = y1;
	}
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_SetRadarEnabled(JNIEnv* env, jobject thiz, jboolean tf)
	{
        ...
        JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_SendClickSettings(JNIEnv* pEnv, jobject thiz, jint id)
	{
        switch (id) {
        	case 0: pNetGame->SendChatCommand("/show_settings_family"); break;
        	case 1: pNetGame->SendChatCommand("/show_shop_family"); break;
        	case 2: pNetGame->SendChatCommand("/show_car_family"); break;
	}
	}
        ...
        JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendAutoShopButton(JNIEnv* env, jobject thiz, jint id)
	{
		...
		Java_com_nvidia_devtech_NvEventQueueActivity_sendUseInventory(JNIEnv * pEnv, jobject thiz, jint i, jint i2)
	{
		pNetGame->UseInventory(i, i2);
	}
	extern "C"
		JNIEXPORT void JNICALL
		Java_com_nvidia_devtech_NvEventQueueActivity_sendInventoryClick(JNIEnv * pEnv, jobject thiz, jint i)
	{
		pNetGame->ClickInventory(i);
	}
	extern "C"
		JNIEXPORT void JNICALL
		Java_com_nvidia_devtech_NvEventQueueActivity_sendDelInventory(JNIEnv * pEnv, jobject thiz, jint i, jint i2)
	{
		pNetGame->DeleteInventory(i, i2);
	}
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_playUrlSound(JNIEnv *env, jclass clazz, jstring url) 
	{
	const char *_url = env->GetStringUTFChars(url, nullptr);

	pNetGame->GetStreamPool()->PlayIndividualStream(_url);
...
void CJavaWrapper::ShowFraction(int id)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showfraction, id);
}
void CJavaWrapper::ShowQuest(int id)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showfractionquest, id);
}
void CJavaWrapper::FixText(int id)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showfractiontext, id);
}
...
void CJavaWrapper::ShowCaptcha() 
{
	...
	env->CallVoidMethod(this->activity, this->s_showCaptcha);
}

void CJavaWrapper::HideCaptcha()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_hideCaptcha);
}
...
void CJavaWrapper::ShowTaxi(int id, int num, int cash, int price, int rast)
{
	JNIEnv* env = GetEnv();
	...
	env->CallVoidMethod(this->activity, this->s_showTaxi, id, num, cash, price, rast);
} 
void CJavaWrapper::ShowSmi(char* smi_edit, char* smi_player, char* smi_textplayer)
{
    JNIEnv* env = GetEnv();
	...
	jclass strClass = env->FindClass("java/lang/String");
                  ...
                  jbyteArray bytes = env->NewByteArray(strlen(smi_edit));
                  env->SetByteArrayRegion(bytes, 0, strlen(smi_edit), (jbyte*)smi_edit);
                  jstring jsmi_edit = (jstring) env->NewObject(strClass, ctorID, bytes, encoding);

bytes = env->NewByteArray(strlen(smi_player));
                  env->SetByteArrayRegion(bytes, 0, strlen(smi_player), (jbyte*)smi_player);
                  jstring jsmi_player = (jstring) env->NewObject(strClass, ctorID, bytes, encoding);

bytes = env->NewByteArray(strlen(smi_textplayer));
                  env->SetByteArrayRegion(bytes, 0, strlen(smi_textplayer), (jbyte*)smi_textplayer);
                  jstring jsmi_textplayer = (jstring) env->NewObject(strClass, ctorID, bytes, encoding);



    env->CallVoidMethod(this->activity, this->s_showsmi, jsmi_edit, jsmi_player, jsmi_textplayer);
}
...
void CJavaWrapper::ShowBrDiner()
{
    ...
    env->CallVoidMethod(this->activity, this->s_showBrDiner);
}
...
void CJavaWrapper::HideBrDiner()
{
    ...
    env->CallVoidMethod(this->activity, this->s_hideBrDiner);
}
void CJavaWrapper::ShowFamily(char* name, int num, int num2)
{
	JNIEnv* env = GetEnv();
	...
	env->CallVoidMethod(this->activity, this->s_showFamily, jname, num, num2);
}
void CJavaWrapper::ShowTuningstage(int money)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showTuningstage, money);
}
void CJavaWrapper::ShowTuningmenu(int money)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showTuningmenu, money);
}
...
void CJavaWrapper::ShowSettingf(char* name, char* statys, int repa, int colivo, int lvl1, int lvl2, int lvl3, int cash, int mater, int masks, int fuels, int ammos, int armors)
{
	JNIEnv* env = GetEnv();
	...
	bytes = env->NewByteArray(strlen(statys));
                  env->SetByteArrayRegion(bytes, 0, strlen(statys), (jbyte*)statys);
                  jstring jstatys = (jstring) env->NewObject(strClass, ctorID, bytes, encoding);

	env->CallVoidMethod(this->activity, this->s_showSettingf, jname, jstatys, repa, colivo, lvl1, lvl2, lvl3, cash, mater, masks, fuels, ammos, armors);
}

void CJavaWrapper::showuluc(int lvl1, int lvl2, int lvl3, int cash, int maxcash, int mats, int mask, int fuels, int ammos, int puples)
{
	JNIEnv* env = GetEnv();
	...
	env->CallVoidMethod(this->activity, this->s_showuluc, lvl1, lvl2, lvl3, cash, maxcash, mats, mask, fuels, ammos, puples);
}
...
void CJavaWrapper::ShowDriving(int id)
{
 JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showdriving, id);
}

void CJavaWrapper::ShowBp(int money, int bc)
{
	JNIEnv* env = GetEnv();
	...
	env->CallVoidMethod(this->activity, this->s_showbp, money, bc);
}

void CJavaWrapper::setTurnState(){
    JNIEnv* env = GetEnv();
    ...
    jmethodID setturn = env->GetMethodID(nvEventClass, "setTurnState",
                                         "(I)V");
    ...
    env->CallVoidMethod(activity, setturn, pVehicle->m_iTurnState);
}

void CJavaWrapper::ShowCalendar(int calendar)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showCalendar, calendar);
}
void CJavaWrapper::showtest()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showtest);
}
void CJavaWrapper::showtuning()
{
    ...
    env->CallVoidMethod(this->activity, this->s_showtuning);
}
void CJavaWrapper::showcatcoin()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showcatcoin);
}
...
void CJavaWrapper::showInventory()
{
	JNIEnv* env = GetEnv();
	if (!env) return;
	env->CallVoidMethod(this->activity, this->s_showInventory);
}
void CJavaWrapper::closeInventory()
{
	JNIEnv* env = GetEnv();
	if (!env) return;
	env->CallVoidMethod(this->activity, this->s_closeInventory);
}
void CJavaWrapper::addItemToInv(int id, int arg, int slot)
{
	JNIEnv* env = GetEnv();
	if (!env) return;
	env->CallVoidMethod(this->activity, this->s_addItemToInv, id, arg, slot);
}
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
	...
	s_showFamily = env->GetMethodID(nvEventClass, "ShowFamily", "(Ljava/lang/String;II)V");
	s_showSettingf = env->GetMethodID(nvEventClass, "ShowSettingf", "(Ljava/lang/String;Ljava/lang/String;IIIIIIIIIII)V");
	s_showuluc = env->GetMethodID(nvEventClass, "showuluc", "(IIIIIIIIII)V");
	...
	s_hideCaptcha = env->GetMethodID(nvEventClass, "hideCaptcha", "()V");



        s_showdriving = env->GetMethodID(nvEventClass, "ShowDriving", "(I)V");
  
        s_showInventory = env->GetMethodID(nvEventClass, "showInventory", "()V");
	s_closeInventory = env->GetMethodID(nvEventClass, "closeInventory", "()V");
	s_addItemToInv = env->GetMethodID(nvEventClass, "addItemToInv", "(III)V");

        s_showCalendar = env->GetMethodID(nvEventClass, "showCalendar", "(I)V");

	s_showShop = env->GetMethodID(nvEventClass, "ShowShop", "(I)V");	
 	s_hideShop = env->GetMethodID(nvEventClass, "HideShop", "()V");

        s_showbp = env->GetMethodID(nvEventClass, "ShowBp", "(II)V");

	s_showHelper = env->GetMethodID(nvEventClass, "ShowHelper", "(I)V");
        s_hideHelper = env->GetMethodID(nvEventClass, "HideHelper", "()V");
	s_showsmi = env->GetMethodID(nvEventClass, "ShowSmi", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");

        s_showPerson = env->GetMethodID(nvEventClass, "ShowPerson", "()V");
	s_hidePerson = env->GetMethodID(nvEventClass, "HidePerson", "()V");
	s_showBrDiner = env->GetMethodID(nvEventClass, "ShowDiner", "()V");
    	s_hideBrDiner = env->GetMethodID(nvEventClass, "HideDiner", "()V");
	...
	s_showTaxi = env->GetMethodID(nvEventClass, "ShowTaxi", "(IIIII)V");
	s_showTuningstage = env->GetMethodID(nvEventClass, "showTuningstage", "(I)V");
	s_showTuningmenu = env->GetMethodID(nvEventClass, "showTuningmenu", "(I)V");

        s_showtest = env->GetMethodID(nvEventClass, "showtest", "()V");
        s_showcatcoin = env->GetMethodID(nvEventClass, "showcatcoin", "()V");
	...
	s_showfraction = env->GetMethodID(nvEventClass, "ShowFraction", "(I)V");
	s_showfractiontext = env->GetMethodID(nvEventClass, "FixText", "(I)V");
	s_showfractionquest = env->GetMethodID(nvEventClass, "ShowQuest", "(I)V");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_nvidia_devtech_NvEventQueueActivity_clickSpeedometr(JNIEnv * env, jobject thiz,
	jint buttonid) {
	// TODO: implement clickSpeedometr()
	switch (buttonid) {
	case 1: { // left
		CPlayerPed* pPlayerPed = pNetGame->GetPlayerPool()->GetLocalPlayer()->GetPlayerPed();
		CVehicle* pVehicle = pPlayerPed->GetCurrentVehicle();
